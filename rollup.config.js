...
const utilsExternalGlobals = new Map([
    ...
    [normalize(join(__dirname, 'src/utils/script-version.js')), 'Toolasha.Utils.scriptVersion'],
    ...
    [normalize(join(__dirname, 'src/utils/community-buffs.js')), 'Toolasha.Utils.communityBuffs'],
    ...
    [normalize(join(__dirname, 'src/utils/patient-tick.js')), 'Toolasha.Utils.patientTick'],
    [normalize(join(__dirname, 'src/utils/pricing-side-select.js')), 'Toolasha.Utils.pricingSideSelect'],
    ...
    [normalize(join(__dirname, 'src/utils/artisan-material-mode.js')), 'Toolasha.Utils.artisanMaterialMode'],
    ...
    [normalize(join(__dirname, 'src/utils/tradable-range.js')), 'Toolasha.Utils.tradableRange'],
    ...
    [normalize(join(__dirname, 'src/utils/react-click.js')), 'Toolasha.Utils.reactClick'],
