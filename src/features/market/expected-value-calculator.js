...
class ExpectedValueCalculator {
     ...
     * market tax still has to be applied. Tax is left to the caller because the chain's own
     * special cases are already net figures and would otherwise be taxed twice.
