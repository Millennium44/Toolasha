...
import { parseItemCount, parseGameNumber, gameDigitsSource } from '../../utils/number-parser.js';
...
class TooltipPrices {
    ...
    _abilityTooltipLevel(abilityTooltip) {
        ...
        const match = (abilityTooltip.textContent || '').match(new RegExp(`Level:\\s*(${digits})`));
