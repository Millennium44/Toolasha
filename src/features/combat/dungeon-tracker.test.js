...
describe('a canceled battle start', () => {
    test('the ended message disarms a run no wave of which ever completed', async () => {
        ...
        tracker.onChatMessage(keyCountsData('2026-08-04T10:26:30.000Z', '[Irokez - 95] [Mazo - 42]'));
        await flush();
        expect(tracker.isTracking).toBe(true);
        ...
        tracker.onChatMessage(keyCountsData('2026-08-04T10:42:17.000Z', '[Irokez - 95] [groezy - 42]'));
        await flush();
