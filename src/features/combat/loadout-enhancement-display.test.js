 ...
 * the loadout panel.
 *
 * This drives the module against `items_updated` and `character_switched`
...
describe('loadout enhancement display — refresh without a DOM mutation', () => {
    ...
    test('updates after a character_switched event with no DOM mutation', async () => {
        ...
        bus.handlers['character_switched']?.forEach((h) => h());
