    ...
    combat: {
        ...
        settings: {
            ...
            labyrinthSimMaxTrials: {
                ...
                label: 'Labyrinth: Single-sim max fights (0 = unlimited)',
                type: 'number',
                default: 20000,
                min: 0,
                max: 10000000,
                step: 1000,
                help: 'Hard cap on the number of fights one Lab Simulator run may use before it stops, regardless of precision. 0 removes the cap, so the run continues until the precision target is met (can be slow for a near-coin-toss room). Only affects the Single Sim tab.',
            },
            labyrinthSimMaxHours: {
                id: 'labyrinthSimMaxHours',
                label: 'Labyrinth: Single-sim time ceiling (hours, 0 = unlimited)',
                type: 'number',
                default: 3,
                min: 0,
                max: 100000,
                step: 1,
                help: 'Simulated-time ceiling on one Lab Simulator run. Precision normally ends the run first; 0 removes the ceiling so only precision and the max-fights cap can stop it. Only affects the Single Sim tab (the live labyrinth tile calculator keeps its own ceiling).',
            },
