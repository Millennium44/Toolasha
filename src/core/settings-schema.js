    ...
    marketplace: {
        ...
        settings: {
            ...
            market_bulkSellAssistant: {
                ...
                type: 'checkbox',
                default: true,
                help: 'Adds a Bulk Sell button to the marketplace tab bar (next to Market History) that queues every tradable inventory item — most valuable stack first, optionally limited to one Toolasha inventory tab — and opens a prefilled sell modal for each: one confirm click per item, always in the same place. Insta-sells when sell orders outnumber buy orders or the ask queue is older than the configured limit; otherwise posts a sell listing.',
            },
            market_bulkSellFloating: {
                id: 'market_bulkSellFloating',
                label: 'Market: Bulk Sell as floating chip',
                type: 'checkbox',
                default: false,
                help: 'Show the Bulk Sell controls as a floating chip near the top-right of the screen (its original position) instead of inline in the marketplace tab bar. Takes effect immediately.',
            },
            ...
            market_bulkSellBookTimeout: {
                id: 'market_bulkSellBookTimeout',
                label: 'Market: Bulk sell order book wait (seconds)',
                type: 'number',
                default: 3,
                min: 1,
                max: 30,
                help: "How long the Bulk Sell Assistant waits for an item's order book to load before skipping it as having no market data. Raise this on a slow connection if items get skipped that shouldn't be. Default: 3.",
            },
            market_bulkSellAdvanceMs: {
                id: 'market_bulkSellAdvanceMs',
                label: 'Market: Bulk sell advance delay (ms)',
                type: 'number',
                default: 400,
                min: 0,
                max: 5000,
                help: 'Pause in milliseconds after a sale confirms before the assistant moves to the next item. Default: 400.',
            },
            market_tradeHistory: {
