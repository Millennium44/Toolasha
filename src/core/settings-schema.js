    ...
    marketplace: {
        ...
        settings: {
            ...
            consumables_labTorchMax: {
                ...
                default: 100,
                min: 0,
                help: 'How many torches one labyrinth run takes in, planned as fully spent. Base 100, +20 per Torch Capacity upgrade — set it to the "max" the Supplies row shows.',
            },
            consumables_labShroudMax: {
                id: 'consumables_labShroudMax',
                label: 'Consumables: Labyrinth shroud capacity per run',
                type: 'number',
                default: 4,
                min: 0,
                help: 'How many shrouds one labyrinth run takes in, planned as fully spent. Base 4, +1 per Shroud Capacity upgrade.',
            },
            consumables_labBeaconMax: {
                id: 'consumables_labBeaconMax',
                label: 'Consumables: Labyrinth beacon capacity per run',
                type: 'number',
                default: 5,
                min: 0,
                help: 'How many beacons one labyrinth run takes in, planned as fully spent. Base 5, +1 per Beacon Capacity upgrade.',
            },
