...
Five enhancement fixes: the Philosopher's Mirror sweep starts at +2 everywhere (the tooltip knew; the networth worker and build score started at +3 and compounded the miss — the sweep now lives once, shared); the enhancing panel keys XP on the item level, not a skill requirement (a level-10 weapon gated behind attack 70 quoted 34.6K XP/hr against the real 4K); the panel runs on the live Blessed Tea chance and quotes the same success rate its own table computes from; and the networth worker stops keeping the marketplace's −1 "no order" sentinel as a price, which had runs coming out cheaper than their own base item.
...
Gold sources gains a Copy button; the net-worth chart shows the all-time high; the exclusion popup totals what's being omitted; the guild trial ledger gains a totals row, a name filter, and a Copy-as-text button; and the roster's contribution list gains the same filter, with the CSV export following it.
...
The Trade Ledger shows totals for the filtered item; the Philosopher's Stone Calculator gains a Copy Table button that copies exactly what's on screen; and watchlist chips get a dashed, dimmed look with a caution note when their price reading is stale.
...
* a "Needs attention" section covering every character ([ebc80ce](https://github.com/Millennium44/Toolasha/commit/ebc80cef639161c6d5930e5bacd0599b78cd24c3))
* alchemy success-rate calibration, stamped forward-only ([3b2b91d](https://github.com/Millennium44/Toolasha/commit/3b2b91dd12bce534ca106c0b03db0f17f7885ca1))
* alert when a savings goal becomes affordable ([1566750](https://github.com/Millennium44/Toolasha/commit/1566750ed09a23e4553c0b9055dc5777614c5ff1))
* briefing lines carry the absolute instant their countdown names ([e4b0c16](https://github.com/Millennium44/Toolasha/commit/e4b0c16c8f66ebcb637870f220f2b8cfc11b66ad))
* features register their own command palette entries ([37519cc](https://github.com/Millennium44/Toolasha/commit/37519cc94c4c24656c2e2119e694186e2273656b))
* fight-pool hygiene line on the labyrinth pool header ([2b5ba95](https://github.com/Millennium44/Toolasha/commit/2b5ba950647998c3ace4b6a440ba18f3f972be79))
* labyrinth burn and torches-per-floor trends in the Consumables panel ([57a6488](https://github.com/Millennium44/Toolasha/commit/57a64885a2a9ec012bb0a1bf77cd0050874ba45a))
* mark lab sim room tiles whose gear has changed since they were computed ([4b9f3e9](https://github.com/Millennium44/Toolasha/commit/4b9f3e92f32f467cdbd621884a06a9412573792d))
* median monster-HP remainder across labyrinth losses ([49cbd3e](https://github.com/Millennium44/Toolasha/commit/49cbd3e7a54f926f076ebee6808a945147d53697))
* name the enhancement parameter source wherever a sweep prices something ([dc7c29c](https://github.com/Millennium44/Toolasha/commit/dc7c29ca0a5dd72912c41a3358c9045c96f385b1))
* per-action and ask/bid drill-down on the calibration panel ([a858878](https://github.com/Millennium44/Toolasha/commit/a8588782d5ef25ba61c54f05dba8b8c606d9d3d0))
* price targets on market watchlist pins ([9fb2de6](https://github.com/Millennium44/Toolasha/commit/9fb2de6c93403a4480e07a942e1e3864a7905b06))
* realized payout per claim by task type in the task statistics panel ([749e0e5](https://github.com/Millennium44/Toolasha/commit/749e0e5c473350bcf86c9e18c7cb0f6175387153))
* remember which overlay layout is in force across a reload ([9c4bfc5](https://github.com/Millennium44/Toolasha/commit/9c4bfc5b1ba997f759e9826a3ba510e108d90b71))
* show the market's own last move on watchlist chips ([499c10f](https://github.com/Millennium44/Toolasha/commit/499c10f572fbe1fbfd91bac54507938c36d600ce))
* show the near-miss line on each pool card ([507a1d2](https://github.com/Millennium44/Toolasha/commit/507a1d2dda87400de10eb4333413be6d2c4c7235))
* show trial recording health live, not only in the export header ([67e5ca7](https://github.com/Millennium44/Toolasha/commit/67e5ca706255b8ec9cda1abc121c9ae2ade516b9))
* snapshot each character's briefing facts as you switch away ([bdaad24](https://github.com/Millennium44/Toolasha/commit/bdaad24af4d1a3ab835a9c6bef5465a745919341))
* split combat calibration into XP and gold, with a verdict ([fa3d755](https://github.com/Millennium44/Toolasha/commit/fa3d7554dd5ca4cef9a472312f3fb6ac4419c9c4))
* split the combat calibration median by gear cohort ([3791803](https://github.com/Millennium44/Toolasha/commit/3791803b9695940ef0c80c3bdf585203b9a58469))
* surface and archive guild trial attribution accuracy ([f94fe14](https://github.com/Millennium44/Toolasha/commit/f94fe142f9ab6a3b852c1e19bc650e5807b4fe01))
* sync pulls combine saved overlay layouts instead of overwriting them ([eec2a7e](https://github.com/Millennium44/Toolasha/commit/eec2a7ecfb93e267163287aadf135714856a025e))
* sync pulls combine the goal planner's goal list instead of overwriting it ([f61f4dc](https://github.com/Millennium44/Toolasha/commit/f61f4dccd0de1a6332023fb85f90779c9f4f5da9))
* sync pulls combine the guild capture stores instead of overwriting them ([c3752d3](https://github.com/Millennium44/Toolasha/commit/c3752d3914d1391f5ead2198a86f63f137a3f607))
* sync pulls combine the inventory watchlist instead of overwriting it ([eec612c](https://github.com/Millennium44/Toolasha/commit/eec612cbf410dd429025e8f457808938ae46f69e))
* the reroll walk says what it has spent, and the summary outlives the widget ([11080ba](https://github.com/Millennium44/Toolasha/commit/11080ba5dab08962f395ec6086b3655e0504c9d4))
* time-to-fill vs undercut depth in the market Ledger tab ([b047fc8](https://github.com/Millennium44/Toolasha/commit/b047fc895741bf873e6e74a042691978e68508df))
* trial capture chips name who is left, and keep focus in the row ([b429d2e](https://github.com/Millennium44/Toolasha/commit/b429d2e4f39b980983bb45e7f9cc5098e9b24272))


### Bug Fixes

* ask for notification permission when the savings-goal alert is switched on ([f140abb](https://github.com/Millennium44/Toolasha/commit/f140abb3510dceebbe3c7ecbdfece56ec0ad7423))
* flag a gold recommendation that leans on an unpriced tea ([a218d7f](https://github.com/Millennium44/Toolasha/commit/a218d7f6d862a0e628e86f191ef36e54a79ffb4f))
* give calculateSkillPerformance an alchemy path ([63a0ea6](https://github.com/Millennium44/Toolasha/commit/63a0ea69f506332860462eade2f1abeb5ea44597))
* guard stored-readings reload against the same double-switch race ([7a1563c](https://github.com/Millennium44/Toolasha/commit/7a1563c768504a46902f23bead65f02339317dd7))
* guard the idle-plan pins against a fast double character switch ([e2092db](https://github.com/Millennium44/Toolasha/commit/e2092db639ddde8df9a312a596ca2cfd5dfad834))
* Iron Bell Farming panel no longer applies a stale costing after a character switch ([5b6a07d](https://github.com/Millennium44/Toolasha/commit/5b6a07db390a4ee935bef37193918571daea90d2))
* Iron Bell Farming stage ticks no longer leak across a character switch ([8411a5d](https://github.com/Millennium44/Toolasha/commit/8411a5dea2861465b87b1b1aa52e9a0f5ad4454f))
* loot log delete no longer races a concurrent history merge ([542952a](https://github.com/Millennium44/Toolasha/commit/542952a1bc7fa1e5449ed2989c9478e535f54785))
* loot log show-more expansion survives a later loot_log_updated ([2c749b6](https://github.com/Millennium44/Toolasha/commit/2c749b65d9d0c6cf1fde61c681a6e3af64e76ce9))
* rank gold tea combos by average, not by sum ([5e012a0](https://github.com/Millennium44/Toolasha/commit/5e012a00ad620061399dd5f1a76a0187cbb7dd38))
* score alchemy equipment on gold when the gold goal asks for it ([eaef13d](https://github.com/Millennium44/Toolasha/commit/eaef13db9a6b3838405b5b7071b6e513fa182d16))
* stop billing unpriced consumables at a fabricated 500 coins ([bbb4d40](https://github.com/Millennium44/Toolasha/commit/bbb4d40819b8a027d6d0d7b51725fd277d8546b8))
* the reroll walk awaits its thresholds before planning ([6606ed3](https://github.com/Millennium44/Toolasha/commit/6606ed39b0ae4f824eadd1bd0eafcc346dd88c24))
* the reroll walk obeys the cap block's on/off switch ([4dbb372](https://github.com/Millennium44/Toolasha/commit/4dbb372dc34bc4934c39259d30c4fbfbde5d0400))
* the upgrade advisor's handoff buttons stop dropping data ([74b106e](https://github.com/Millennium44/Toolasha/commit/74b106ee0667c77f0f72a8165ebe90df2786fe51))
* trial aura coverage reports its denominator instead of a blanket Unknown ([ecf743e](https://github.com/Millennium44/Toolasha/commit/ecf743e55a9a30fcdd0bf61804be5d16f3e49555))


### Code Refactoring

* one enhancement pricing rule, in a module every bundle can reach ([fd374b8](https://github.com/Millennium44/Toolasha/commit/fd374b8c81db66236031fd5597bdc2fdd35a6afd))
* one protect-from sweep engine, with a single-run answer on top ([b2adaae](https://github.com/Millennium44/Toolasha/commit/b2adaaece821c34694615026674a7ffda1398135))
* score calculator reads the shared trainee shop price ([c18a9eb](https://github.com/Millennium44/Toolasha/commit/c18a9ebc6588ebbc8dc3655decf78a753b4095ac))
* the item tooltip sweeps through the shared engine, and stops pricing protection at zero ([d37b90f](https://github.com/Millennium44/Toolasha/commit/d37b90fe6c6df94dadd3f6d28b16194e1d79b96d))
* the savings card costs a run through the shared engine ([136916e](https://github.com/Millennium44/Toolasha/commit/136916e657a786ea1bd40842feaa01ae914f7d66))
* the upgrade advisor costs a run through the shared engine ([3c1c84d](https://github.com/Millennium44/Toolasha/commit/3c1c84de0c1a9862463644f6c84b63fa34e403c5))


### Documentation

* changelog for fill times and task payouts ([5fbcae3](https://github.com/Millennium44/Toolasha/commit/5fbcae38bbe24211b9892af153dc1549ead79b9e))
* changelog for palette registry, lab trends, gear markers; allowlist async-pool ([bcfac93](https://github.com/Millennium44/Toolasha/commit/bcfac93664d2a00fdb4e8baaa075a2c8b5e8418d))
* changelog for price targets and source chips ([3118af7](https://github.com/Millennium44/Toolasha/commit/3118af75e180b9ec7a39b87de0858417d4784ece))
* changelog for the account-wide briefing ([17147b7](https://github.com/Millennium44/Toolasha/commit/17147b7490d4e75ee95673d367876aff48fdf15e))
* changelog for the alerts, movers chip, and trace health ([86ddba7](https://github.com/Millennium44/Toolasha/commit/86ddba7a9442983b3ea2d9e4d55bc185b20d3fe6))
* changelog for the calibration and pool verdicts ([2b625cf](https://github.com/Millennium44/Toolasha/commit/2b625cf90a00b101d3b6f67888e06cd0af69c32b))
* changelog for the calibration drill-downs ([33962c5](https://github.com/Millennium44/Toolasha/commit/33962c51d88c0937695f56f50829e138fa3a13b3))
* changelog for the capture sync merges ([3fd958a](https://github.com/Millennium44/Toolasha/commit/3fd958ae6464c2e5947d5ae471611cbc828769a3))
* changelog for the consumables audit ([af67e16](https://github.com/Millennium44/Toolasha/commit/af67e16086fa70aa5b662dff1ecdbb0b6066cf9f))
* changelog for the ironcow switch fixes ([fc91b63](https://github.com/Millennium44/Toolasha/commit/fc91b6310ebf22f4d500c598b65f12e565326aa2))
* changelog for the layout memory and advisor handoff ([aab802f](https://github.com/Millennium44/Toolasha/commit/aab802f6bb58c33ce1831a762c94eff2c5c23cae))
* changelog for the loot log fixes ([7080a67](https://github.com/Millennium44/Toolasha/commit/7080a6778aff4b26baf826241fc78af269f3b711))
* changelog for the near-miss line and walk spend ([3930de6](https://github.com/Millennium44/Toolasha/commit/3930de638dcf265d7dca4a8318d052fd24470867))
* changelog for the trial accuracy card ([dd76aaa](https://github.com/Millennium44/Toolasha/commit/dd76aaa1d7f8e2ac27d482a76a9e7f92eed71f6e))
* changelog for the trial capture chips ([5c4e046](https://github.com/Millennium44/Toolasha/commit/5c4e046b934c712d73306d00ef3e60553d8dfff9))


### Tests

* characterise the four enhancement cost sweeps before consolidating ([c572f9c](https://github.com/Millennium44/Toolasha/commit/c572f9c07257f43b5c003ff1097e22411f13141a))
* resolve import paths in the bundle-bridge guard ([895ef7f](https://github.com/Millennium44/Toolasha/commit/895ef7fd0a2facb35706c231be4668a3d3c479d8))
...
- alchemy sessions record when they were last seen acting ([ca481b3](https://github.com/Millennium44/Toolasha/commit/ca481b3befa747a6a0693046fe1df0d5fbd621e9))
- one-press Update for the saved layout in force, with an (edited) drift marker ([ee19b17](https://github.com/Millennium44/Toolasha/commit/ee19b171c431de8ea1e20dc3c75bbb7786f6eaad))
- recommend badge marks a threshold at the search ceiling as at-least ([df12967](https://github.com/Millennium44/Toolasha/commit/df12967dba55d66345b30319e28a835204a9b6ff))

### Bug Fixes

- a chunked history's legacy key was not covered by its sync merge ([7111fb6](https://github.com/Millennium44/Toolasha/commit/7111fb661534499d4eeadadad00c269019644fd5))
- a DOM handler unregistering mid-dispatch no longer skips its neighbour ([8aa5b9a](https://github.com/Millennium44/Toolasha/commit/8aa5b9a7a3c64680e270cb0947d2979315e812d2))
- a superseded networth recalculation no longer overwrites a newer one ([2f1dd33](https://github.com/Millennium44/Toolasha/commit/2f1dd3365b8cd6a9089aa8f6e3680052426b6737))
- a sync pull discarded this device's market listing anchors ([f3b12a5](https://github.com/Millennium44/Toolasha/commit/f3b12a5da40a58b540515a983c9e02bfcc0f3c6d))
- a sync push uploads the database without the writes still queued ([2227604](https://github.com/Millennium44/Toolasha/commit/2227604f6bfab0d0b3f815b044bbed8902bd1441))
- an immediate storage write or delete is no longer undone by a queued one ([33f5ba5](https://github.com/Millennium44/Toolasha/commit/33f5ba57698444d6cb76f74aa1af12294c967a8d))
- artisan tea is production-only, never a gathering recommendation ([90ac551](https://github.com/Millennium44/Toolasha/commit/90ac551b99d2f62bd457690255094326c60cb450))
- await feature teardown before the character pointer moves on a switch ([140c0bf](https://github.com/Millennium44/Toolasha/commit/140c0bfb166f7d2d10ae66efd692733bea36cd23))
- battle counter clears stale numbers on character switch ([9ec70a6](https://github.com/Millennium44/Toolasha/commit/9ec70a69d0a5551afeeca13cf61ab5fae66e8d53))
- battle counter keeps its last id when new_battle omits one ([0b5e11b](https://github.com/Millennium44/Toolasha/commit/0b5e11b9e5a8e11cb130440cbbb98a523d62604a))
- binding enhancement sync no longer overlooks the equipped copy ([6fea1e0](https://github.com/Millennium44/Toolasha/commit/6fea1e028b5979c3840b973a0fa30dfff1c5f524))
- bulk sell forgets the remembered inventory tab on a character switch ([b6e466b](https://github.com/Millennium44/Toolasha/commit/b6e466b2f7e13ba585fc47f1178065172d3d5b2d))
- cap per-metric measurement history between stat reads ([c32113a](https://github.com/Millennium44/Toolasha/commit/c32113a56ed66c63991633fd90dc26f4695de557))
- capture the pointer on floating-panel drag and resize handles ([28c6318](https://github.com/Millennium44/Toolasha/commit/28c63185c9512c6478228f2039b46d3cea9ccd3e))
- capture the pointer while dragging a game modal ([e5aac1b](https://github.com/Millennium44/Toolasha/commit/e5aac1b07f6ea5fa788beec9b1a388087b6a698c))
- captured Trial Stats modal cache leaks across a guild or character switch ([359e624](https://github.com/Millennium44/Toolasha/commit/359e624e5692c1d0651c0ea5039c820703c2e382))
- combat battle counter/boss ETA disable clears timers even if teardown throws ([97b9d4d](https://github.com/Millennium44/Toolasha/commit/97b9d4d40afed3ea7d8ccf5c1d6204395bbff4e5))
- combat DPS fallback resets accumulators between runs ([8e69266](https://github.com/Millennium44/Toolasha/commit/8e6926600e537f51fe19b06d6d1d1ff50896c216))
- config.onSettingChange hands back an unregister function ([6cc11b4](https://github.com/Millennium44/Toolasha/commit/6cc11b46d3fe5a3e9b86dd3bf29ea33eca3db6de))
- cost-basis fallback no longer prices an enhanced item at its +0 cost ([8e7fac8](https://github.com/Millennium44/Toolasha/commit/8e7fac837fc0470becbff653147d35355ccf216c))
- cover the task cap thresholds in the scoped-data repair tool ([817f8f0](https://github.com/Millennium44/Toolasha/commit/817f8f0d603a65b2658ad47bd5df65d309a936d9))
- damage taken no longer misreads a hit hidden by a bigger heal ([a4328c1](https://github.com/Millennium44/Toolasha/commit/a4328c160f06d21662ac861a4436c8e93249b39c))
- drop a delayed minimize restore once the user has already toggled it ([5237ced](https://github.com/Millennium44/Toolasha/commit/5237ced916087bcecf23ffdc8762704be036ee91))
- dungeon tracker chat annotations ignore player messages ([e5bc6a3](https://github.com/Millennium44/Toolasha/commit/e5bc6a388f5b9acef33f4e03249b1b0ed64aeaed))
- dungeon tracker chat tab selector survives CSS-module hash drift ([de7bf60](https://github.com/Millennium44/Toolasha/commit/de7bf606f6c3f32ce0e6d12cf056dba2efc7b8ac))
- enhancement sessions on an unpriced base item are valued at its cost basis ([e956c17](https://github.com/Millennium44/Toolasha/commit/e956c173783b648e723a42b1a6b852c151a1c9b7))
- enhancing panel keys XP on the item level, not a skill requirement ([55df873](https://github.com/Millennium44/Toolasha/commit/55df8734a92084b5f0687b37cecce0218245fe6b))
- enhancing panel quotes the success rate its own table is computed from ([236a094](https://github.com/Millennium44/Toolasha/commit/236a0941aa8485304d7db02a2942f2f2d85a590a))
- enhancing panel runs on the live Blessed Tea double-jump chance ([e520bf6](https://github.com/Millennium44/Toolasha/commit/e520bf667cd9365a2f858d0c159f7e9c439a8e78))
- equipment savings counts an equipped copy with no count field ([bf6b0f0](https://github.com/Millennium44/Toolasha/commit/bf6b0f0c1763686cac2feb156a5c740c09735779))
- estimated listing age tertiary item match no longer guesses on collision ([292ee8f](https://github.com/Millennium44/Toolasha/commit/292ee8f62ec2ff3277e95790c657e68f95ccaa0a))
- gathering profit bonus-revenue breakdown ignored efficiency multiplier ([aa9929a](https://github.com/Millennium44/Toolasha/commit/aa9929a375de56fb64671f85d719c871f273d373))
- guild shrine plan edited just before a character switch is no longer dropped ([f724887](https://github.com/Millennium44/Toolasha/commit/f7248879bc6c6a1e794a3418abb067651d683080))
- guild trial ability captures fall back per character ([160d76d](https://github.com/Millennium44/Toolasha/commit/160d76d0d789c970e15a068dba14c3e71c020077))
- guild trial forecasts stop merging two alts' own stats ([2f38c55](https://github.com/Millennium44/Toolasha/commit/2f38c55417ccd1f63933da11960c0f617c6055a9))
- importEverything strips excluded storage keys too, not just the exporter ([da6af74](https://github.com/Millennium44/Toolasha/commit/da6af74294c083e0358d063824b663f4f4d5ace1))
- interval tracing re-nets each timer independently on reinstall ([d704efa](https://github.com/Millennium44/Toolasha/commit/d704efa953ef6bce5d846250b90ed9842a90bfce))
- iron cow mode deletes the snapshot it read, not the arriving character's ([949ae21](https://github.com/Millennium44/Toolasha/commit/949ae21a8639bb77c3fc66fcfe30a37367ecb27f))
- lab sim combat level box matches the finder's min room level ([3973062](https://github.com/Millennium44/Toolasha/commit/3973062f79a8a7af3366406bfab2a67b3654075b))
- labyrinth recommend search discards a partial result when its sims are cancelled ([440208d](https://github.com/Millennium44/Toolasha/commit/440208d54c87398f6102079263d0ace2756c93b0))
- labyrinth room logs stops leaking an XP-grace timer past disable() ([119f2e6](https://github.com/Millennium44/Toolasha/commit/119f2e6b402386d181b931e7074c963cbbb4bf03))
- make the two teardowns that persist scoped state actually finish ([c004c9b](https://github.com/Millennium44/Toolasha/commit/c004c9b67f5a423809dd4b739a4a378c80159e76))
- mirror the +2 enhancement step everywhere, not just in the tooltip ([0b0461b](https://github.com/Millennium44/Toolasha/commit/0b0461bc8a058c835806e0eb257f5330ae4ef279))
- networth popup prices excluded loadouts at the level they wear ([cb5e303](https://github.com/Millennium44/Toolasha/commit/cb5e303b36f1951a4b5a91b85b86e2658dbbd14f))
- networth worker stops charging negative coins for unquoted materials ([8cc5e68](https://github.com/Millennium44/Toolasha/commit/8cc5e6898be75b62b2afe1bc74aa7321c3ca347d))
- one throwing setting-change listener no longer starves the rest ([a2f7617](https://github.com/Millennium44/Toolasha/commit/a2f76176d75330ce475bf20dbdeccafe90704be2))
- overlay icon tiles redraw when their sprite sheet becomes available ([9045195](https://github.com/Millennium44/Toolasha/commit/90451952ee60935935b1a75fa82c91d22631eda7))
- overlay layout v2 is repairable after a restore ([074b48d](https://github.com/Millennium44/Toolasha/commit/074b48ded24c22ad31b5a956500b0181d37de60e))
- overlay pinned column count survives layout save, export and reapply ([883453d](https://github.com/Millennium44/Toolasha/commit/883453d7eaa8b5166204da9db85bc16efcf0325e))
- overlay Reset layout also unpins columns ([ee45c5f](https://github.com/Millennium44/Toolasha/commit/ee45c5f02b33245e5d47e103751bb96b9131e96a))
- performance report worst stall survives the display ring ([7f4de4a](https://github.com/Millennium44/Toolasha/commit/7f4de4a781e42e9f235326b7121bc58a0b02dd52))
- price enhancement materials and protection items in the sweep ([597ea6a](https://github.com/Millennium44/Toolasha/commit/597ea6a80cd3f35896e8fd00b99f254116ed8ce8))
- scoped reads answer an absent legacy without a microtask hop ([d9eff5e](https://github.com/Millennium44/Toolasha/commit/d9eff5ec74b1fd37f8de9a719c146b3ae528eee4))
- ship the worker reconciled prices, not the raw order book ([490692a](https://github.com/Millennium44/Toolasha/commit/490692a18a73a4de24a92a8be6a32fe3ff54ff81))
- skilling optimizer equipment ranking warns on unpriced materials ([f4e87f3](https://github.com/Millennium44/Toolasha/commit/f4e87f381ec3f707accb17d0fa4e74fb0c676ad4))
- spread alchemy and enhancement gold over the days a run spent ([cd69b43](https://github.com/Millennium44/Toolasha/commit/cd69b433ab22e28bb7024f4ae1306f1ead4b3adb))
- stall attribution aligns on the monotonic clock ([b4aaedf](https://github.com/Millennium44/Toolasha/commit/b4aaedf496411d7494ca22193dedc91677f5ce64))
- stop flushAll's straggler retry putting back a value a newer write replaced ([6daeab5](https://github.com/Millennium44/Toolasha/commit/6daeab556795f5aeb2b0c1294171b1c9af766db2))
- sync pull merges against a stale base while writes are still queued ([8ae55fb](https://github.com/Millennium44/Toolasha/commit/8ae55fbf65efdb682c024c33284a85f1690aa962))
- task cap thresholds no longer leak from the main to every alt ([3bc586c](https://github.com/Millennium44/Toolasha/commit/3bc586c862be5c17d3dda00112d239b13901c3d3))
- the consumables idle plan pins are per character ([16d333f](https://github.com/Millennium44/Toolasha/commit/16d333f03991c0c66d31190609b36e67d13c1e10))
- the restore latch waved through the recorders it exists to stop ([e254969](https://github.com/Millennium44/Toolasha/commit/e2549690399607129dab10abdafdc6c5bbcb3361))
- the trial-signups fold is actually remembered across reloads ([188168d](https://github.com/Millennium44/Toolasha/commit/188168dee4c1e333a4dc136a7523798ef0ea8aab))
- timer call-site parser handles async, new, and anonymous frames ([cc83324](https://github.com/Millennium44/Toolasha/commit/cc833244f5811e38d54ffe86aa063106d964cf5f))
- timer trace wrappers keep their names under minification ([601f357](https://github.com/Millennium44/Toolasha/commit/601f357a89784c2cd84758ce0a78b56dd4327834))
- undoing an overlay layout switch restores the column count and its pin ([e5e47e7](https://github.com/Millennium44/Toolasha/commit/e5e47e7d4fbb7fdf99f34b3a8bf33045994a3aa2))
- worker matches any recipe output and divides by its count ([e825acd](https://github.com/Millennium44/Toolasha/commit/e825acdbe999ee153d059cccfc16e96192e0a3c3))
- worker prices craft-cost inputs at the net worth pricing mode ([079fb7e](https://github.com/Millennium44/Toolasha/commit/079fb7e7a953f0b8f913b5a9464144882b1f171a))

### Performance Improvements

- action countdown skips its tick in a hidden tab ([c958099](https://github.com/Millennium44/Toolasha/commit/c9580991d053bd55f5118c23859ad0a81a191a3b))
- consumables panel skips the swap when a redraw changes nothing ([742e05d](https://github.com/Millennium44/Toolasha/commit/742e05d9d8245abe7e2b86fc031e7b07172ab8b4))
- reroll spend badge stops rewriting an unchanged label ([f91186a](https://github.com/Millennium44/Toolasha/commit/f91186abc800785d531ce37c90313640e5939a2d))
- watchlist skips the swap when a redraw changes nothing, and a folded panel is left alone ([9a5ea96](https://github.com/Millennium44/Toolasha/commit/9a5ea966cd7da2664d3e1bc3ceab463e302b4c17))

### Documentation

- changelog for round-13 gold-basis and labyrinth-recommendation fixes ([717b5d1](https://github.com/Millennium44/Toolasha/commit/717b5d1dec3dc6372dcf214bceb3620b56ee564c))
- changelog for round-14 dungeon and damage-ledger fixes ([86aafb3](https://github.com/Millennium44/Toolasha/commit/86aafb31a0d5fcfb1c012e5935fcf512671fd3df))
- changelog for round-14 leftovers batch ([be30258](https://github.com/Millennium44/Toolasha/commit/be30258ec918e7103a999b32c849eb87d98bd6b4))
- changelog for round-14 listing-age collision fix ([8846757](https://github.com/Millennium44/Toolasha/commit/8846757ca03266741a44fcd43dfadea49c662963))
- changelog for round-14 scoping fixes ([a035944](https://github.com/Millennium44/Toolasha/commit/a035944cc10fef07d6e1a7ff42ae2392eab96511))
- changelog for round-14 session day-spreading ([4e51cbf](https://github.com/Millennium44/Toolasha/commit/4e51cbfe0c6cacc579a5652c60df315d41998aff))
- changelog for round-14 trial stats modal scoping fix ([71f0f25](https://github.com/Millennium44/Toolasha/commit/71f0f253e35a0ea045a81d4be4a666e1e0bbe55e))
- changelog for round-14 worker valuation unification ([fa80511](https://github.com/Millennium44/Toolasha/commit/fa805119fe89de4b6d7b111123f13675abdae2d7))
- changelog for round-15 core and panel fixes ([9ae7f59](https://github.com/Millennium44/Toolasha/commit/9ae7f59138cb766521fe9e7be3188fdaad729287))
- changelog for round-15 savings and optimizer fixes ([0121595](https://github.com/Millennium44/Toolasha/commit/01215950331e39518cac4414719be9f2de8e4dd4))
- changelog for round-15 sync and enhancement batches ([558469d](https://github.com/Millennium44/Toolasha/commit/558469d01ae39013df19ba26b876447ead54f8ab))
- changelog for the fold fix and modal pointer capture ([83fcb91](https://github.com/Millennium44/Toolasha/commit/83fcb91120856830e89b26763cd362ed0a350044))
- changelog for the rest of round 13 ([c362956](https://github.com/Millennium44/Toolasha/commit/c362956309cf2e3095c981244ceb97626f1833e7))
- changelog for the round-13 battle-counter switch fix ([2feae6e](https://github.com/Millennium44/Toolasha/commit/2feae6e1e3b1f3baf432f3d6ffb9c2df231259f7))
- changelog for the round-14 leftovers ([8b37e2d](https://github.com/Millennium44/Toolasha/commit/8b37e2d7d22209a4a0bec2b5ef31f358042a41c6))
- changelog for the switch-teardown ordering fixes ([811d5fb](https://github.com/Millennium44/Toolasha/commit/811d5fb5c71b44a01523c53a6f9a309521389a6d))
- changelog for the sync probe and import strip ([881e08c](https://github.com/Millennium44/Toolasha/commit/881e08c086d1acc28f757241cb5922f816e7bb26))
- changelog for the teardown-leftover fixes ([ddc8a3c](https://github.com/Millennium44/Toolasha/commit/ddc8a3c0592ca4492306e28e7774c15c3d9ddb2a))
- fix a stray character in the round-15 changelog entry ([7351296](https://github.com/Millennium44/Toolasha/commit/73512968d66b5b355e6ab326676a8fe21d2b305e))

### Styles

- prettier the new enhancement-math tests ([afefaaa](https://github.com/Millennium44/Toolasha/commit/afefaaab365119fa5fce57c80a49f0e3e753eb64))

### Tests

- a hidden tick leaves the readout untouched, a visible one paints. ([c958099](https://github.com/Millennium44/Toolasha/commit/c9580991d053bd55f5118c23859ad0a81a191a3b))
- differential fixture proves the networth worker closure is complete ([58d9fae](https://github.com/Millennium44/Toolasha/commit/58d9faef86c0f77567de4ad2ec185a282d93f120))
- pin down Tab Reorder's immunity to the stuck-drag pattern ([03dead9](https://github.com/Millennium44/Toolasha/commit/03dead9f1e93d1707b27e27b6e1a27f39c384662))
- pin gathering bonusRevenue as base-rate, not efficiency-scaled ([619c4e7](https://github.com/Millennium44/Toolasha/commit/619c4e7658563528a56eb4068bbe2b76f777575c))
- probe the sync-merge registry's real registrations for overlap and coverage ([00f1819](https://github.com/Millennium44/Toolasha/commit/00f18194611104cc1a35b3d226fc29740a83a629))
- prove skilling/enhancing clamps hold across the widened ±1000 window ([ebe6307](https://github.com/Millennium44/Toolasha/commit/ebe63078beeeb791ba378e52185dbfd631bdfe88))
- same input twice, the body's first element keeps its identity. ([9a5ea96](https://github.com/Millennium44/Toolasha/commit/9a5ea966cd7da2664d3e1bc3ceab463e302b4c17))
- same input twice, the body's first element keeps its identity. ([742e05d](https://github.com/Millennium44/Toolasha/commit/742e05d9d8245abe7e2b86fc031e7b07172ab8b4))
- same spend twice, the badge's text node keeps its identity. ([f91186a](https://github.com/Millennium44/Toolasha/commit/f91186abc800785d531ce37c90313640e5939a2d))
