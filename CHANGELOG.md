...
## [3.0.0](https://github.com/Millennium44/Toolasha/compare/v3.12.1...v3.0.0) (2026-08-17)


### Features

* ability-level goals in Equipment Savings ([342bf0f](https://github.com/Millennium44/Toolasha/commit/342bf0fe7ebd16d5808960375283d95410ff86b4))
* add attribution comparison harness with counter-based referee ([77b8671](https://github.com/Millennium44/Toolasha/commit/77b86713c27d0cbc2bdc55effe909f99fccf635b))
* add opt-in Profile button to combat battle-unit popup ([9e63c74](https://github.com/Millennium44/Toolasha/commit/9e63c7489de5b842e966aa05bf293b57acceeb47))
* add per-tab run caps and Uncapped toggle to Lab Simulator ([e0db373](https://github.com/Millennium44/Toolasha/commit/e0db3739d38a1911c079ac558f68997f1f74c7c0))
* add precision and max-fights controls to Lab Upgrade tab ([766132f](https://github.com/Millennium44/Toolasha/commit/766132fc83a8e00df9fae1ec68a3843fb2a1d505))
* add uncappable fight/time limits to Lab Simulator Single Sim tab ([ac356a2](https://github.com/Millennium44/Toolasha/commit/ac356a2c2809093283ff562c50eeb011bd1684a4))
* advisor/task/enhancing fixes, craft adapter, alchemy fixes, test sweep ([9f09cb8](https://github.com/Millennium44/Toolasha/commit/9f09cb89ffc4c6eb17e77f967e9308b8a66dacbc))
* Build Score breakdown panel ([4fe11c1](https://github.com/Millennium44/Toolasha/commit/4fe11c15d575df602f611fa0e31083ff0030e13a))
* capture the game's end-of-trial stats to check the measurement ([9570875](https://github.com/Millennium44/Toolasha/commit/95708757c224eef6aa38f5be4ef42fd683383d86))
* **chat:** /profile click-to-fill on every name Toolasha renders ([87d47ef](https://github.com/Millennium44/Toolasha/commit/87d47ef9ad3fefd6bdefc806e8feda7e1a173041))
* colour labyrinth rooms cleared only for a chest apart from the exit path ([22a6b4f](https://github.com/Millennium44/Toolasha/commit/22a6b4f7fe056d0ebb4a790a27111fe40f1278e9))
* **combat-profit:** rename MooPass toggle, add a real sale-tax toggle ([980b605](https://github.com/Millennium44/Toolasha/commit/980b605189abf6257c2df21ae87f5c6abff2a126))
* **combat-sim:** add a target button to each Results row ([f856c64](https://github.com/Millennium44/Toolasha/commit/f856c645b1d3d8fb713f1bec2b41f17804faa13c))
* **combat-sim:** add an Achievements section to toggle achievement combat buffs ([5410db0](https://github.com/Millennium44/Toolasha/commit/5410db09fc2496e9632e3ea7e8a2ce6714bb0e6f))
* **combat-sim:** carry Labyrinth scrolls in the sim and upgrade advisor ([83c5356](https://github.com/Millennium44/Toolasha/commit/83c5356843343a7c9d763f5a092d0095de7dff25))
* **combat-sim:** make the guide swap option aura-only instead of aura+signature ([605bc59](https://github.com/Millennium44/Toolasha/commit/605bc59008a3a5572fae876ac4c4254a14761be9))
* **combat-sim:** net the market sale tax off drop revenue ([7d85851](https://github.com/Millennium44/Toolasha/commit/7d858519c077169177fe52c2452ca7a4f12c9025))
* **combat-sim:** panel parity — partial results, reachable Stop, CSV, budget planner ([126461c](https://github.com/Millennium44/Toolasha/commit/126461c73055b920ec4fe3c44f8733d94877802f))
* **combat-sim:** per-shrine Targets grid on the Guild Shrine upgrade ([ad12683](https://github.com/Millennium44/Toolasha/commit/ad126836ac28634e9ba32816fd25b7e7878bb051))
* **combat-sim:** sim proposed path boots at +7, not the worn level ([79e1228](https://github.com/Millennium44/Toolasha/commit/79e1228c64d74e3b65b3d849914a122caa34b321))
* community buff expiry alerts; live buff levels ([e71255f](https://github.com/Millennium44/Toolasha/commit/e71255f9775c1037731f8dbc99ef248708f6a1ac))
* configurable token buffs, ability union targets, shrine grid ([8bd2b6e](https://github.com/Millennium44/Toolasha/commit/8bd2b6ecd7c28324acda0cd3ad510af028ed50d7))
* consent dialog before data adoption; backups named per character ([bf20fa8](https://github.com/Millennium44/Toolasha/commit/bf20fa87a105232de079aa9033e23bd7bfd405ee))
* craft arbitrage adapter forwards skipProcessing and timeCostPerHour ([efa2354](https://github.com/Millennium44/Toolasha/commit/efa2354dcb65b11b539e5d8657685190bb09e3e8))
* cycler clicks battle units first, skipping the dead ([880f471](https://github.com/Millennium44/Toolasha/commit/880f4711195415b4f0af634cf09ee6210f8b470c))
* default combat sim crates to equipped; richer recommendation & breakdown tooltips ([8feb150](https://github.com/Millennium44/Toolasha/commit/8feb15032b0139ba7ea5fc234b22fbd3eb080172))
* **dev:** on-demand health report via Toolasha.debug.health() and a Ctrl+K command ([0e306fd](https://github.com/Millennium44/Toolasha/commit/0e306fdaa32cdae911fd43f15e273dbe9458ae9c))
* direct-recipe-only setting now drives the global profit math ([217baf9](https://github.com/Millennium44/Toolasha/commit/217baf919de2606af64a9c42f041661202aea733))
* dismissable marketplace tabs; lab-sim tabs clear on close ([e017ea5](https://github.com/Millennium44/Toolasha/commit/e017ea5b72c9d99bec38aff16ba7e078e56663e7))
* dungeon keys costed at the cheaper of craft vs buy ([3cbe184](https://github.com/Millennium44/Toolasha/commit/3cbe1845278b4f0ab564c243fee579e8c8f307a5))
* enhancement tooltip labels its stats source, toggleable to pro rates ([ded880e](https://github.com/Millennium44/Toolasha/commit/ded880ed0cf482303d2329b05fef8888a7b8312b))
* **enhancement:** cost-vs-expected (luck) and worth-it lines in the tracker ([aaba5d6](https://github.com/Millennium44/Toolasha/commit/aaba5d6cff5dada41914e5c9cb85af23b1d9d7a0))
* **enhancement:** expandable worth-it breakdown + command-palette toggle ([eadb716](https://github.com/Millennium44/Toolasha/commit/eadb716958f2f777b04bdd06c41ef21d41b8d880))
* **enhancement:** idle-duration fix, session merge, on-screen toggle ([35892de](https://github.com/Millennium44/Toolasha/commit/35892de6e864310476dd61b66af5031c8034c175))
* **enhancement:** make the pro/yours source toggle discoverable and mobile-friendly ([512a5d3](https://github.com/Millennium44/Toolasha/commit/512a5d3be2052b31b1a9780df9321dfedd162d8a))
* **enhancement:** route any item from the XP/hr panel, even unowned ([edae384](https://github.com/Millennium44/Toolasha/commit/edae38409a0fab8fdc0d15a170ce9620b45bda69))
* executable bundle-sharing check, house-cost dedup, bundle bridge ([b447d49](https://github.com/Millennium44/Toolasha/commit/b447d4950d0c9e66366b7c9d8f58567711d74d5e))
* explain a failed library load at startup instead of a cryptic crash ([97534b9](https://github.com/Millennium44/Toolasha/commit/97534b982fa19af5a47d79c6326c1b45f81a8213))
* expose combat lab sim precision control in the sim panel ([8d8f89b](https://github.com/Millennium44/Toolasha/commit/8d8f89bcf7053a3c1899d8be804baff2aaf2e773))
* flatten item-tooltip materials breakdown to the direct recipe ([fe2ca45](https://github.com/Millennium44/Toolasha/commit/fe2ca45c187869148953c05a68e39e887c78c887))
* gate 8/13 marketplace-patch behaviour to the test server ([ea798f0](https://github.com/Millennium44/Toolasha/commit/ea798f0d7612efad1ead31d255554dcd72fddc1a))
* gist sync, account view, philo corrections, lab audit fixes, housekeeping ([e9826ca](https://github.com/Millennium44/Toolasha/commit/e9826ca6f565ce82c96dc7c8ff26946bb47a688c))
* goal planner — ordered steps from goal to done ([47fbbbd](https://github.com/Millennium44/Toolasha/commit/47fbbbd232bbccbcc8ac5238bfb44fa5f7e4c679))
* guide-based ability swaps, signature-only, crit aura retired ([841ab3a](https://github.com/Millennium44/Toolasha/commit/841ab3aa55e4ccbde52a93e46066f053f24dd3b9))
* guild shrines in advisors/editor/score, calibration, roster, storage hardening ([37da645](https://github.com/Millennium44/Toolasha/commit/37da645757b681e0bc7719070c097d581dd67174))
* guild shrines in profile scores and net worth ([b45abc1](https://github.com/Millennium44/Toolasha/commit/b45abc1ae829a7be881613546c08b8564b631ec2))
* Guild Shrines series in the networth history chart ([7603855](https://github.com/Millennium44/Toolasha/commit/7603855bd8d934f57ce6daf66af6e38279eaa921))
* guild trials row layout, drop treasury note, schedule the start alert ([e258ca5](https://github.com/Millennium44/Toolasha/commit/e258ca5cde39234d746155ef45df51ac61607d27))
* guild trials suite, trial recorder and forecasting, labyrinth path/beacon rework, sync encryption, mobile fixes ([bb2ac2b](https://github.com/Millennium44/Toolasha/commit/bb2ac2b5f4a765442fd48bbc1b20c2e2d98c169f))
* guild-shareable trial report with shortfall, deaths, and mana depletion ([e9a98f2](https://github.com/Millennium44/Toolasha/commit/e9a98f2fbbbba2616129270c6a30e20738e814d5))
* **guild:** price tokens via credit exchange; 2%/level bonuses; /shrines ([bd4db93](https://github.com/Millennium44/Toolasha/commit/bd4db9352f2a74794f7f172137042f702803372b))
* **guild:** trial pace, ETA, and payout projection on In Progress tab ([40a9b48](https://github.com/Millennium44/Toolasha/commit/40a9b48027b7e7d62a4560c177a0f28151311b92))
* gzip the sync payload so Everything fits one gist ([53fb602](https://github.com/Millennium44/Toolasha/commit/53fb6025b835ebca8ebae523419eb6047beff805))
* house-level goals in Equipment Savings ([32de144](https://github.com/Millennium44/Toolasha/commit/32de14417ba7f6f6bf66e93dc2f885ea02c9055a))
* hybrid attribution, trial split measured, tool-slot lint fix, book tooltip ([ddede36](https://github.com/Millennium44/Toolasha/commit/ddede36b93dc6399247b6fe999d7c213658261a3))
* idle-member names fill /profile on click ([48f5f27](https://github.com/Millennium44/Toolasha/commit/48f5f27a3938d128ac68ac756c9c6d4e5ec68c33))
* integrate the five guild-trial wire messages ([483b2f0](https://github.com/Millennium44/Toolasha/commit/483b2f048e4fbb6e2c9b6335235fc04425c704c0))
* Iron Cow Farm panel — the cowbell loop, costed honestly ([79069c8](https://github.com/Millennium44/Toolasha/commit/79069c81b1ccf8522b6ab5cf8592db8d5905890b))
* lab house/token/community scopes, honest gear costing, per-column gradient ([15b3164](https://github.com/Millennium44/Toolasha/commit/15b3164e8f07dd165c3c39b330a4b247f60b30c4))
* lab sim task-fight removal, row actions, per-item labels, houses ([431c0ca](https://github.com/Millennium44/Toolasha/commit/431c0ca9f8c21a7e52e96a6f5ab68bb8c77d0f32))
* lab-sim replay splits the damage gap into hit-rate vs damage-per-hit ([21a4e39](https://github.com/Millennium44/Toolasha/commit/21a4e390cffb100b9dd7a4b51652c2c0ab177bf7))
* **lab-sim:** combined armor swaps and ability swaps across targets ([dd0a833](https://github.com/Millennium44/Toolasha/commit/dd0a8339f353940625a712d509dfa71ceb7ba9b0))
* **lab-sim:** comparison runs and multi-select upgrade dimensions ([0d5f02b](https://github.com/Millennium44/Toolasha/commit/0d5f02bfef25f98226176c2121bdfc1564767c0c))
* labyrinth mobile — fit tile badges, add quick-calc and auto-calc buttons ([1d8badb](https://github.com/Millennium44/Toolasha/commit/1d8badb555079ad737ae3674d721063f2f7908e0))
* labyrinth-finish, combat-death, enhancement-target alerts ([feee9be](https://github.com/Millennium44/Toolasha/commit/feee9be74d8d6c048a013a33e4080188f986f74e))
* **labyrinth:** break equal-route ties toward revealing the most unknown rooms ([2180974](https://github.com/Millennium44/Toolasha/commit/21809745ae5f210c16941290bb0e07c9ea9e7f5b))
* **labyrinth:** embed the replay comparison in the exported recording ([ef977bf](https://github.com/Millennium44/Toolasha/commit/ef977bf2466b8bad2613076fa3e56466a02a19de))
* **labyrinth:** fight recorder and calibration replay ([065055d](https://github.com/Millennium44/Toolasha/commit/065055d5019aa5bb464cba0f934ff9f857349625))
* **labyrinth:** full-ability sim calibration setting, tooltip clear-time, panel bar polish ([7b84583](https://github.com/Millennium44/Toolasha/commit/7b845833e49396557427119df602ccf9b29da5d3))
* **labyrinth:** passive, persistent, gear-pooled fight recorder ([0d3f823](https://github.com/Millennium44/Toolasha/commit/0d3f823f43f220d7fb0d538acf28c38821ad769e))
* **labyrinth:** raw tick capture as a Capture button ([fd438f9](https://github.com/Millennium44/Toolasha/commit/fd438f9e1fe1bac74f264e5c406473fa178c4363))
* **labyrinth:** recompute button, server-count reconciliation, scroll preservation ([99c962b](https://github.com/Millennium44/Toolasha/commit/99c962b8a370c36b279043b9f8f06d36c4f03722))
* **labyrinth:** self-label captures, drop partial-HP fights from replay ([68303a6](https://github.com/Millennium44/Toolasha/commit/68303a621584ed324fc6596b61bc00fb39f67fa7))
* liquidity and capital bounds on planner gold rates ([dd0900c](https://github.com/Millennium44/Toolasha/commit/dd0900cd492f65b6e1c45fac0bee36652843dcdc))
* liquidity cap on alchemy, action, and all-zones profit displays ([41cc3f3](https://github.com/Millennium44/Toolasha/commit/41cc3f3e1bf197c5b50f39b2b270dd1c098ca7d7))
* listing-age anchors grow from recorded and observed listings ([d50645f](https://github.com/Millennium44/Toolasha/commit/d50645fce08c903d3f0c3e2724c4ad999a60d8fe))
* loose next-tier estimate for un-joined trials; quiet two noisy lab diagnostics ([c70594e](https://github.com/Millennium44/Toolasha/commit/c70594ef22665373920d17c1d93fda202f046b6d))
* **loot-log:** enhancing cost, luck and profit summary (opt-in) ([4dc5fc3](https://github.com/Millennium44/Toolasha/commit/4dc5fc34af70fe4c223c7e4a06ac20822deff679))
* **loot-log:** merge split enhancing runs + larger summary text ([60fb4be](https://github.com/Millennium44/Toolasha/commit/60fb4be45680bf4878da72600cd44dda02ecbc89))
* **market:** add "Check Mooket price" button to the marketplace item view ([d590be1](https://github.com/Millennium44/Toolasha/commit/d590be129b4f8fca29944421da8776952e028904))
* **market:** add mooket I as a selectable price-history source ([d79c0f5](https://github.com/Millennium44/Toolasha/commit/d79c0f5549fe604da6f41f1d06c4555ecfbc9110))
* **market:** contribute order books to the selected mooket source ([785f931](https://github.com/Millennium44/Toolasha/commit/785f93186199ba99e6e77534a0a7e895eda56570))
* **market:** refresh My Listings Top Order Price on market-data updates ([4e14e80](https://github.com/Millennium44/Toolasha/commit/4e14e802fdc7318f854831edf2b56ab5ae265f47))
* **market:** replace item-view Mooket check with a My Listings bulk price refresh ([8399e4d](https://github.com/Millennium44/Toolasha/commit/8399e4db8e07c784f3f8ecaff21136916993ecee))
* max-tier food option for all-zones sims ([706d7c0](https://github.com/Millennium44/Toolasha/commit/706d7c03fc5380349036f61960eb20d1b6ef6eaf))
* missing-material tabs auto-retire on acquisition ([78bb281](https://github.com/Millennium44/Toolasha/commit/78bb281ab545b9a3a3d79f93afd259c37dd4ec6a))
* mobile-friendly lab controls and compact action bar ([bd7add2](https://github.com/Millennium44/Toolasha/commit/bd7add29114ccb9cf030d966ad7d0678476082b4))
* **mobile:** pointer-event drags everywhere, viewport clamps, mobile mode ([f3b9f87](https://github.com/Millennium44/Toolasha/commit/f3b9f872d90292150d6426428126904ec62c2425))
* **mobile:** the phase-1 sweep — clamps, pointer drags, hidden-tab timers, worker teardown ([88cc3a6](https://github.com/Millennium44/Toolasha/commit/88cc3a693a8e88a75604a07cfa0d8dbc1b9f8410))
* **mobile:** touch equivalents for gesture-only features; remove the dead Sell Queue ([bd9fbf6](https://github.com/Millennium44/Toolasha/commit/bd9fbf639367e3c3a27d597bdb5b9a7a06823f8e))
* monster stat check — game live stats vs sim, on click ([d4184c8](https://github.com/Millennium44/Toolasha/commit/d4184c84bc8cad9736782c2ed03c409018307c91))
* monster stat check "Run blind sim" — does the sim produce the effects at all ([895e2ba](https://github.com/Millennium44/Toolasha/commit/895e2bab376f4c9a57b59d813e48ebca7945a094))
* monster stat check applies the unit's live effects to the sim ([7fb317b](https://github.com/Millennium44/Toolasha/commit/7fb317b64ec37e1cc663cbe67ed968daea3190bc))
* monster stat check baseline toggle; fix vanishing nav controls ([faa885b](https://github.com/Millennium44/Toolasha/commit/faa885b076082326cd0af44d571c384f59e00179))
* monster stat check classifies debuffs, and logs/exports discrepancies ([8cb88ea](https://github.com/Millennium44/Toolasha/commit/8cb88ea89669bb3bbac1c0d12921afa5c10a0580))
* monster stat check history paging + clear ([930d9b3](https://github.com/Millennium44/Toolasha/commit/930d9b360e212da9d7fd74b627312a0d34e2a610))
* monster stat check log — store toggle and discrepancy-first paging ([590614b](https://github.com/Millennium44/Toolasha/commit/590614b901dbf7132deadc5ac5d6527bcf517ad6))
* monster stat check log is a labelled corpus; stat-recompute invariant test ([2016913](https://github.com/Millennium44/Toolasha/commit/20169134aa97f3162f3df222ca08b6d55ac31b52))
* monster stat check log persists across refreshes ([b380430](https://github.com/Millennium44/Toolasha/commit/b3804308d6744dea4f3efa1bf8978f0950a301e0))
* monster stat check panel grows to fit, resizes, and copies to clipboard ([60db80f](https://github.com/Millennium44/Toolasha/commit/60db80f05abb1e4b01e444f34a4675a09b2d323e))
* net-worth value-source setting (order book vs game's market value) ([e4eb49e](https://github.com/Millennium44/Toolasha/commit/e4eb49e11620a82e900bb7b8cd91dd139bff8bbd))
* networth overlay tiles open the history chart ([57c0d0d](https://github.com/Millennium44/Toolasha/commit/57c0d0df0f45d0ede5a1cd561960639cfa3bc77c))
* neutral companion wording, shared Record control, mooket guard ([b7a366f](https://github.com/Millennium44/Toolasha/commit/b7a366f5f7a74453df011fc40ea48d1ecd25c077))
* **notifications:** active market-snapshot refresh so undercut alerts see current prices ([50d85b9](https://github.com/Millennium44/Toolasha/commit/50d85b9e627f2a53c7aa53d9fd563971ef659145))
* **notifications:** back undercut alerts with fresh Mooket sightings ([e09a14a](https://github.com/Millennium44/Toolasha/commit/e09a14abb4fd1d5c893bd337790381f9456eae02))
* **notifications:** notify when a labyrinth entry regenerates (opt-in) ([42cc89d](https://github.com/Millennium44/Toolasha/commit/42cc89d2537061ab12fad61ab26b50a62511931d))
* notify on your own level-ups and reaching a Time-to-Level target ([937daed](https://github.com/Millennium44/Toolasha/commit/937daeda23d73f1827a1c6f87207fad07b43def1))
* offer a full backup on first fork run ([2fd93c5](https://github.com/Millennium44/Toolasha/commit/2fd93c56b590d2a903eb84aa7cd8e2ad6e99aaba))
* official lab formulas, ladder cost, replay check, alchemy rules, canary ([a4657e8](https://github.com/Millennium44/Toolasha/commit/a4657e86dd8dfe75c50daa47c2570eec82639526))
* on-screen trial stats comparison + mobile lab-sim tab access ([8e5031b](https://github.com/Millennium44/Toolasha/commit/8e5031bc78a3bfd1c5378a20ec889a86b3ce8719))
* open party profile directly via handleViewProfile ([8e89d24](https://github.com/Millennium44/Toolasha/commit/8e89d24bf516851c001fa1404953b12d5b50f5a1))
* open profiles directly via shared helper across all /profile sites ([2943a3b](https://github.com/Millennium44/Toolasha/commit/2943a3bcd4eac21f39f69a90098ce341c6048961))
* optional passphrase encryption for cross-device sync ([793af25](https://github.com/Millennium44/Toolasha/commit/793af251e2c3b249d5d9af139f52d1fd7919aac9))
* **overlay:** compact/hidden empty tiles and a curated default ([737a0fb](https://github.com/Millennium44/Toolasha/commit/737a0fbdcdc54c2c4099cca0ddf17040550797f6))
* **overlay:** five new tiles, layout presets, activity auto-switch ([ecd6e7d](https://github.com/Millennium44/Toolasha/commit/ecd6e7d35a366e0b564c62587d649ed5ca6d1bb9))
* **overlay:** rework curated default tiles, add reset button; un-gate 8/13 patch ([899bdd1](https://github.com/Millennium44/Toolasha/commit/899bdd15b1fba759678905bbb3e440250517bdf9))
* palette opens settings to the row; Iron Cow preset chip; IC copy ([1c70d65](https://github.com/Millennium44/Toolasha/commit/1c70d657405a20cfbefa10789c6c7593bb04745e))
* path overlay lights the walk to the plan's first step ([d40e093](https://github.com/Millennium44/Toolasha/commit/d40e093cacab5f3658aea268c7a82e3143466852))
* per-player trial DPS, seen loadouts, payout provenance ([a74be1b](https://github.com/Millennium44/Toolasha/commit/a74be1bf08dec9c581fe840422bbc4aa572ebf7f))
* planner ledger, instant replan, step navigation, honest windfalls ([66241e4](https://github.com/Millennium44/Toolasha/commit/66241e4a3340e368c5b44c2b3b036aa8b837f8fb))
* product-review wave one — backup, presets, health checks, savings trend, cache persistence ([010c527](https://github.com/Millennium44/Toolasha/commit/010c5272be3c804c1c8a7536f89e8b36691087d2))
* profile links, chest-luck profit option, warming-up tile, solo compare ([400015d](https://github.com/Millennium44/Toolasha/commit/400015dc1e4805d9acc3acf41e1a341122438931))
* **profile:** count shrine levels in gear score and combat sim ([c254b92](https://github.com/Millennium44/Toolasha/commit/c254b920b27a798604a11ec5d3f32c79bd3ada77))
* read sim-accuracy exports in the attribution comparison ([526263b](https://github.com/Millennium44/Toolasha/commit/526263b56c417552b2780ad12b6b3b0b5f17c05e))
* reconcile prices against the game's official market values ([f7d3813](https://github.com/Millennium44/Toolasha/commit/f7d3813e355866668ce86bea1266c80f7dfa8b82))
* record targets, XP checking, DPS decomposition, check history ([d5d9bf6](https://github.com/Millennium44/Toolasha/commit/d5d9bf6af7cdb10b664cbd4dfd05304672e44f7e))
* recorder loadout snapshots, checkpoints, rotation, noise bands ([2b8501c](https://github.com/Millennium44/Toolasha/commit/2b8501c65e11a5ffdb680703a33dfb0589d46388))
* rename to Iron Bell Farming; add next-step overlay tile ([ba40b62](https://github.com/Millennium44/Toolasha/commit/ba40b62c77c5ac5377fb2bbdfacf4459c005f261))
* reword profile-link tooltips to "Open &lt;name&gt;'s profile" ([dbf828d](https://github.com/Millennium44/Toolasha/commit/dbf828d68104dd499adcb22ffa31acf7b3535ac6))
* run the uptime harness from the Monster Stat Check panel ([183764a](https://github.com/Millennium44/Toolasha/commit/183764a304101c06240d99505fd8b2af11d8a39c))
* scope skilling sim to its skill, add community buffs ([ba4af64](https://github.com/Millennium44/Toolasha/commit/ba4af64444fbe9904aa6862a678995c79cb700c4))
* set combat forecast beside the fight; sum the whole wave in the damage feed ([554c6d5](https://github.com/Millennium44/Toolasha/commit/554c6d5e187069fcd6705a2c1148968f3639d92a))
* **settings:** copy first-run settings from another character, recoverably ([ac859c5](https://github.com/Millennium44/Toolasha/commit/ac859c50d6d60fc78f9480246ff0c3ba8c6e6290))
* **settings:** default the seven Portrait DPS sub-readouts to off ([97a8135](https://github.com/Millennium44/Toolasha/commit/97a8135cfe63c5f602f84b6ffd3b3c375219ccc6))
* **settings:** defaults-first welcome, a no-change option, safe dismissal ([09aeffc](https://github.com/Millennium44/Toolasha/commit/09aeffca08a18b2e232c62eceb46816849f9f44b))
* **settings:** first-arrival choice between fork defaults and keeping things as they were ([b85a7d1](https://github.com/Millennium44/Toolasha/commit/b85a7d111b832dfe63039ad3ab4c1cc089125863))
* **settings:** offer "Keep my current settings" to returning users at first run ([682ceaa](https://github.com/Millennium44/Toolasha/commit/682ceaac04ea68e0240351e793f66852716f99f2))
* **settings:** rename the "Everything on" preset to "Defaults" ([ae2d352](https://github.com/Millennium44/Toolasha/commit/ae2d3527a91ec68b864997024a25df41db857e33))
* **settings:** render the what's-new popup cleanly + add a newcomer overview ([4099899](https://github.com/Millennium44/Toolasha/commit/409989944af938a498c8c68ee876b43a2e36ad38))
* **settings:** safer defaults for new-settings-off and market dimming ([2eed1c8](https://github.com/Millennium44/Toolasha/commit/2eed1c8588050fdd07857924f387fde829d4efe7))
* **settings:** what's-new popup per update, and conservative new-setting defaults ([dfb5fac](https://github.com/Millennium44/Toolasha/commit/dfb5fac3e7ca81a86a67af5cb1483e74a2b8466d))
* seven optional live-combat readouts on portraits, tiles and the tracker ([1171d4f](https://github.com/Millennium44/Toolasha/commit/1171d4f4983d8d363cd4b8daf4350dfc48a44038))
* shared per-character storage key helper ([44c249a](https://github.com/Millennium44/Toolasha/commit/44c249a7cbbc0a19b0f6358cb43c3911ccef1a06))
* sim summary units, party lint, entry keys in tracker, chest key button ([9927953](https://github.com/Millennium44/Toolasha/commit/99279536192aebc66e733d708a1859e5764948fa))
* sim-vs-measured line, live party lint, archived session picker ([0c5858d](https://github.com/Millennium44/Toolasha/commit/0c5858d497244609cd32f3be14f699a7c8b27d19))
* **sim:** offer refined path boots as upgrade candidates at +7 ([4c3e8ac](https://github.com/Millennium44/Toolasha/commit/4c3e8ac083c78dd2a131b3df6cccf180733c55c8))
* **sim:** results summary tiles, clear-all baselines, shrine target level ([c3ba044](https://github.com/Millennium44/Toolasha/commit/c3ba0449f9adcbf719611b57c7b5593963bf377f))
* **sim:** taskDamage, achievement buffs, graceful unknowns, sustain view ([802fde5](https://github.com/Millennium44/Toolasha/commit/802fde58241c0fdf13232d038d1a4d18ca00184e))
* **sim:** viewed-level ability fresh-cost, default score sort, path-boot swap test ([4a1747d](https://github.com/Millennium44/Toolasha/commit/4a1747d51f3c0e18b902ada19a530661c54ae207))
* spectated guild battles are measured via guild_battle_updated ([66fc580](https://github.com/Millennium44/Toolasha/commit/66fc5802d49b89df0baddbb16cae0ab5746a667c))
* task-slot fill alert, derived trial tier forecast, guildmate profile logger ([313d5b9](https://github.com/Millennium44/Toolasha/commit/313d5b930c96e4f50ed82eea66f5ddd9151b9a60))
* **tasks:** let a manual Sort Tasks press sort even with a reroll menu open ([9ce1d08](https://github.com/Millennium44/Toolasha/commit/9ce1d081f96da5af764b454756774e9e7dfdfc11))
* **tasks:** remove the bulk-reroll button ([48aeb73](https://github.com/Millennium44/Toolasha/commit/48aeb737a9ce7491fab19773c90eb8bcc58270c6))
* Toolasha.debug.exportTrialData() trial recorder export ([2378d5d](https://github.com/Millennium44/Toolasha/commit/2378d5dec4bbb44836b924bc9d234d439d685a2a))
* **tooltips:** show fresh-to-level cost when hovering an ability itself ([ac1e906](https://github.com/Millennium44/Toolasha/commit/ac1e906c746acf3c5865811425e39afb12bf115d))
* trade ledger, gathering drop luck, csv exports; panels work in flight ([a8cf956](https://github.com/Millennium44/Toolasha/commit/a8cf95674893870defe74805d8d30ce9bb3ce31e))
* trial auto-recorder, ranked scoreboard, and measured per-player support stats ([1f0516a](https://github.com/Millennium44/Toolasha/commit/1f0516aea18b829a30cc3a73847f5d85d4566be1))
* trial history, sim calibration, undercut alerts, canaries, golden run ([d8ecd13](https://github.com/Millennium44/Toolasha/commit/d8ecd13118dd05044ae136031786f6a6bc1a6812))
* **trials:** credit partial-tier progress in the pace projection (test server only) ([0372f9e](https://github.com/Millennium44/Toolasha/commit/0372f9e6a1bce8fbb557d0f91fd2d6baeff9c7e3))
* **trials:** drop the flat tier projection once slowing is known; timestamp skilling readings ([c7e41c9](https://github.com/Millennium44/Toolasha/commit/c7e41c97860b4341d160e738efa7dd0015e004d4))
* **trials:** prefer the game's post-trial stats in the per-player scoreboard ([3fb1797](https://github.com/Millennium44/Toolasha/commit/3fb179796efe0ad1758c703aac16fcc9f1b34da0))
* **trials:** scrape the post-trial Combat Trial Stats modal (test server) ([4db535f](https://github.com/Millennium44/Toolasha/commit/4db535f10a3a00c7b779ac15a57f96c4781580f8))
* **trials:** stand a tile in for a composite fight so Trial Swarm shows on In Progress ([2ebd105](https://github.com/Millennium44/Toolasha/commit/2ebd1056e63c238338d924e1fe43dff9eef7e0f8))
* **trials:** trim the In Progress payout, add a Roster button, and finish the layout escape ([4bc76d2](https://github.com/Millennium44/Toolasha/commit/4bc76d2808600beb27211e71a5fad786ba3cc763))
* **ui:** minimize any panel; remember Combat/Lab upgrade results (opt-in) ([f3cae22](https://github.com/Millennium44/Toolasha/commit/f3cae229da3d4c480b8259bffcdcb24feb005606))
* **ui:** sim panel geometry persistence, stable upgrade tables, z-index tiers ([9779008](https://github.com/Millennium44/Toolasha/commit/9779008ebb4e2ab537fa54955692d5c61aa7b5b2))
* upgrade advisor recommends path boots at +10 for a +10 wearer ([ac6f0cb](https://github.com/Millennium44/Toolasha/commit/ac6f0cb8e3cf40bb2c52143b01e0f129062739b2))
* uptime harness — monster incoming damage decomposed per ability, real vs sim ([0741730](https://github.com/Millennium44/Toolasha/commit/0741730d0963cc6bc311cea45af0bd14f5458c86))
* uptime harness button auto-arms a tick capture when none exists ([dda4527](https://github.com/Millennium44/Toolasha/commit/dda4527a983981ab109b142200a41ea0ca649b31))
* verdict-gated upstream ports, task-damage gating, decompose fee helper ([ef48f92](https://github.com/Millennium44/Toolasha/commit/ef48f929ee289a03ce761264a91ce848c3798d8d))
* wave three — command palette, named layouts, zones in the ranked list, advisor handoffs ([2e57fe3](https://github.com/Millennium44/Toolasha/commit/2e57fe3cf36c539e1df5040a2266fa1d3f00d38e))
* wave two — notification service, price provenance, prefix selectors, canary ([4f823ae](https://github.com/Millennium44/Toolasha/commit/4f823ae8f3eb2a14d94843b1291ba65902645604))
* **ws:** capture the game socket and log outgoing frames to replay a reroll ([99632d0](https://github.com/Millennium44/Toolasha/commit/99632d0f3b5e603e1b8d2307075bcb0d3f135b1d))


### Bug Fixes

* a canceled battle start no longer records a phantom dungeon run ([6943468](https://github.com/Millennium44/Toolasha/commit/6943468c237d87e6b488efe497e5039abc02b9f9))
* Accuracy Reset clears the recorded fight pool, not just the tallies ([5a07a1f](https://github.com/Millennium44/Toolasha/commit/5a07a1f61b6a16e34f117365894c3c1f3ae8d55f))
* **actions:** disconnect the action-name observer before replacing it ([5b93c4c](https://github.com/Millennium44/Toolasha/commit/5b93c4c691cf3a94a420cc74fa615db6bb52fd65))
* align trial forecast boxes to the tile columns (four for skilling) ([fabac5c](https://github.com/Millennium44/Toolasha/commit/fabac5c0de44a9c2e9894e7c2dee77e9caf0a0ab))
* allow gist raw host, guard never-synced push ([2bcc12e](https://github.com/Millennium44/Toolasha/commit/2bcc12e86d849bdb15f77e2335c828eac20dd84e))
* anchor the combat forecast box to the panel so it hugs the enemies at width ([191cdd6](https://github.com/Millennium44/Toolasha/commit/191cdd65b9aeaf3f0a3d15e9b8c35e45f9a93691))
* apply the live spectator tier on the In Progress fight view ([bfa831b](https://github.com/Millennium44/Toolasha/commit/bfa831bb8b34d991c618c424fd3c18e457bbe952))
* auto-record arms on live readings, manual sessions never self-stop, T1 by rule ([57b625a](https://github.com/Millennium44/Toolasha/commit/57b625a85a1068453ff2e1843b6d1a0c57f9269c))
* badge counts banked tiers, derived skilling ladder, forecast walks the hour ([8fb0cc2](https://github.com/Millennium44/Toolasha/commit/8fb0cc2c521b53b9c7536145b263d92b2f0e4c39))
* battle units only match inside the fight's own subtree ([5085c67](https://github.com/Millennium44/Toolasha/commit/5085c67ddaa42c03654247caa1b2bd9291b50758))
* beacon plans cover the exit path first, count resets per floor, one-click auto mode ([1d63da2](https://github.com/Millennium44/Toolasha/commit/1d63da21a7d8e610bafd2efe600b3c889125c394))
* budget planner estimates fallback, book autofill, score prefs ([f9e39db](https://github.com/Millennium44/Toolasha/commit/f9e39db2169b20b23758959f8ae339859862cd6d))
* **build:** minify [@require](https://github.com/require) bundles to fit Steam's 2MB per-require limit ([16c7413](https://github.com/Millennium44/Toolasha/commit/16c741307935c8e9252d32b93bd149a330dd2ab1))
* bulk reroll settles cards it touches and takes undiscovered free rerolls ([8af0b97](https://github.com/Millennium44/Toolasha/commit/8af0b972512417e8f9526c5cd0f7566877c68a8d))
* **bundles:** read expected-value calc and scroll sim through the bridge ([af8e85e](https://github.com/Millennium44/Toolasha/commit/af8e85ecb1d70864f8bef90765979214e2b5339a))
* **bundles:** route remaining cross-bundle singleton reads via the bridge ([cb4fb1e](https://github.com/Millennium44/Toolasha/commit/cb4fb1e85849099fdb6cdcb32793744a4f10b903))
* **bundles:** share action-panel sort/pin singleton via the bridge ([d172705](https://github.com/Millennium44/Toolasha/commit/d1727056041a7af797903b17abadb9b3bf6ac2c1))
* **bundles:** share custom-price-overrides as one Toolasha.Utils global ([3f178fe](https://github.com/Millennium44/Toolasha/commit/3f178fed506b6b9b73bb163c37d1d745d0c625e5))
* **canary:** stop the skill-action-name canary false-alarming on alchemy/enhancing panels ([767018b](https://github.com/Millennium44/Toolasha/commit/767018b22144348b21dbda7a4f695b0048285dfc))
* capture-confirmed cycler, measured success decline, per-kind phases, no walls ([5c39b6b](https://github.com/Millennium44/Toolasha/commit/5c39b6b4e4302e609841c7477f51e1c148c6172b))
* carry lab clears across a live refresh; player check tolerates combat buffs ([bdd0a90](https://github.com/Millennium44/Toolasha/commit/bdd0a90ded15dbe50b563fbf88157e0fea02020b))
* carry room level through a mid-fight monster promotion ([caf08b3](https://github.com/Millennium44/Toolasha/commit/caf08b31f8e5de2f5f90c20be5c57a331f912df8))
* **chat,treasure:** clickable guild joins, content-fit popup, drag without pinning ([9327390](https://github.com/Millennium44/Toolasha/commit/9327390e6a324ffba50341ad2335248a935693c9))
* **chat:** stop turning the guild-wide broadcast subject "Guild" into a /profile link ([86130a3](https://github.com/Millennium44/Toolasha/commit/86130a322f213913796f178696b20919f726ef1a))
* chest-value adjustment reads the treasure ledger, not drop counts ([c05cd50](https://github.com/Millennium44/Toolasha/commit/c05cd50cbe76a394b528c8bd8c3c95ff83057e5a))
* claimLegacyData force-completes adoption after a restore ([443ac00](https://github.com/Millennium44/Toolasha/commit/443ac00d3b318a60924e809c9883c57a4b0ef036))
* clamp floating panels to the viewport, mobile panel usability ([261658e](https://github.com/Millennium44/Toolasha/commit/261658ef0d6ebc607e60a0b8bbeeeb0378d51b45))
* close the wrong-character adoption hole; add scoped-data repair ([12b17cc](https://github.com/Millennium44/Toolasha/commit/12b17cc5a58e971374b58c0a93688dcf7939f8bd))
* **combat-panels:** profit panel leads with the live rate, sim forecast to the foot ([3bda788](https://github.com/Millennium44/Toolasha/commit/3bda7884fd91fa3fcfddf3118a41c0efa6a93528))
* **combat-sim:** apply the drop sale tax on the Results panel too ([a0eb6de](https://github.com/Millennium44/Toolasha/commit/a0eb6deb81159e5533236333b9aa16f026f567b9))
* **combat-sim:** offer the aura group's OR-alternative in Ability Swaps ([2396466](https://github.com/Millennium44/Toolasha/commit/2396466acf6ac0897e78056f09f4809e63e7117c))
* **combat-sim:** reach the shared loadout store via the bridge so packaged builds sim real gear ([6090005](https://github.com/Millennium44/Toolasha/commit/60900057cbd73591688f2ea5f9815529dc56e1cd))
* **combat-sim:** restore the loadout picker in packaged builds ([3a0e1c5](https://github.com/Millennium44/Toolasha/commit/3a0e1c586dd1a90a60cbf380a16dbe57b78461bd))
* **combat-sim:** use the real combat scroll set, read from tooltips not the seal table ([eb4c558](https://github.com/Millennium44/Toolasha/commit/eb4c558607875065a3dd4d989b645bd508d78f30))
* combat, labyrinth, and dungeon records scoped per character ([1116007](https://github.com/Millennium44/Toolasha/commit/1116007bbe477417a7fc85cb06b5dfdc2354a4ac))
* community cap is 20; add Reset to Me / Reset to Party ([8de92dd](https://github.com/Millennium44/Toolasha/commit/8de92dd75ecec4b17a5e94fcd45fb3cf243f03e6))
* community ceiling, popover, charms, market handoff, zone score ([0255a86](https://github.com/Millennium44/Toolasha/commit/0255a86c27b5de35e4d3ac5d71ecc4a39a1bad37))
* **core:** port upstream character-switch and settings-cache fixes ([4ec034f](https://github.com/Millennium44/Toolasha/commit/4ec034fbbd25320e35aa6204a01340eef6ce767f))
* correct the shipped in-game changelog wording ([3977f6b](https://github.com/Millennium44/Toolasha/commit/3977f6b15cd1a4a4920743eea47208a53538e362))
* count guild partial-tier credit on live, not just test server ([c637b0c](https://github.com/Millennium44/Toolasha/commit/c637b0c568f4d0668daf2166f37678456444da9d))
* **custom-tabs:** dedupe enhanced tiles in the Unorganized bucket ([cb42b99](https://github.com/Millennium44/Toolasha/commit/cb42b990cdc730d69196a091183bae198f195646))
* dead units are clicked like anyone else ([4c4fc5d](https://github.com/Millennium44/Toolasha/commit/4c4fc5d3e002349cbde6244939feac7c888f2b3e))
* deaths ride the support table, pinned revive-at-tier test ([580ea88](https://github.com/Millennium44/Toolasha/commit/580ea889c6b90d9ebacff933d604750bbb7a6064))
* default Lab Upgrade tab to own character and keep the player pick ([972338a](https://github.com/Millennium44/Toolasha/commit/972338a6c4cf03d8ea40ddba27760969f2ee50ef))
* draw item tooltip sections even when market prices are off ([830ab10](https://github.com/Millennium44/Toolasha/commit/830ab10cfd0b0b87434a3069f2e931f13d3b2788))
* draw walked cleared tiles on the labyrinth route; revert promotion no-op ([9d0f772](https://github.com/Millennium44/Toolasha/commit/9d0f772d7a8679a1ab02ba844a995dcf867b7fde))
* drop personal combat from the spectated trial DPS split ([d92d13d](https://github.com/Millennium44/Toolasha/commit/d92d13dd458740415bcf02d3236aabc1a4e598ba))
* dungeon run anchors, guards, and export slot naming ([1819ff1](https://github.com/Millennium44/Toolasha/commit/1819ff1397b080f1d118a049ad4391f013ebbae1))
* e-watch searches all protection strategies; ladder mode button ([843e66d](https://github.com/Millennium44/Toolasha/commit/843e66d86633685f6a60d8ff8d247cc67e6bf02f))
* exact trial payout math and combat damage rates across tier clears ([109525c](https://github.com/Millennium44/Toolasha/commit/109525cade890fb522d9774cff4009d914235986))
* find the trials tab structurally; enabled tiles acknowledge ([26bf699](https://github.com/Millennium44/Toolasha/commit/26bf69912946a173021d13637d0b2184081d595e))
* fire the skill milestone alert only on the game's guild broadcast ([d9e07d3](https://github.com/Millennium44/Toolasha/commit/d9e07d3752a688d106fb11f3c17f2fb048542722))
* fold live offense buffs into the player-build sim column ([6756ae8](https://github.com/Millennium44/Toolasha/commit/6756ae82b731b381809ecaafa126814141b34bfe))
* fold multi-enemy combat waves into one HP pool for the clear ([54e6eeb](https://github.com/Millennium44/Toolasha/commit/54e6eeb060c18ecd8a8560a466cdc0f73f0cbf71))
...
* gather trial forecast boxes into a compact row, and stop them reverting ([1a343ac](https://github.com/Millennium44/Toolasha/commit/1a343acc7d8b78ff3800c873653c137388e3bb71))
* group labyrinth tile controls so they wrap tidily on mobile ([b5d8276](https://github.com/Millennium44/Toolasha/commit/b5d827634a54e889267679fd21f397e22ede5bc9))
* **guild:** bank damage by name at wave boundaries; guild-scope loadout sightings ([33ceabe](https://github.com/Millennium44/Toolasha/commit/33ceabe0d28365ac92a3c8502ee06c6a95dd1984))
* **guild:** battle units found via MiniUnit boxes; battle info split from the profile walk ([ffeaed4](https://github.com/Millennium44/Toolasha/commit/ffeaed412020c033af8a29b322d746a9dafb6bc9))
* **guild:** battle-unit clicker matches real CombatUnit boxes, not its own panel ([3f0a17a](https://github.com/Millennium44/Toolasha/commit/3f0a17ae2af08d82543cb6b3943bf996d7652d99))
* **guild:** building levels clamp at 20, distinct from 21 trial tiers ([de60edd](https://github.com/Millennium44/Toolasha/commit/de60edd1750f9d7dbf3546d1caf672c0112139fa))
* **guild:** forecast ladder anchors on the live bar and stops dying after one tier ([20584ef](https://github.com/Millennium44/Toolasha/commit/20584efdbcbd006ab9f2569917cd02d2c4b17aca))
* **guild:** identify trial tier on the in-progress tab and project pace on the exact ladder ([e56dadd](https://github.com/Millennium44/Toolasha/commit/e56dadd392c318976ae052d215dba233904326fb))
* **guild:** roster survives refresh, names stay injective, regen self-classifies, joint tier solve ([645ad03](https://github.com/Millennium44/Toolasha/commit/645ad03540ac026be47a33e9ae7eff1d1822d6b9))
* **guild:** say when every fighter's combat sheet is fresh instead of hiding the button ([3e73ea7](https://github.com/Millennium44/Toolasha/commit/3e73ea72933baa36fe81414efc0756871790bd0f))
* **guild:** scope per-player DPS to its tile, re-anchor drifting panels, cut redundant work ([9281eb1](https://github.com/Millennium44/Toolasha/commit/9281eb1cee1cac0358b7c043372b3ab4971e15c0))
* **guild:** stale tiers die with their pool, combat learns its tier, clock guards everywhere ([c984ceb](https://github.com/Millennium44/Toolasha/commit/c984cebf534907777102ff118c22f17420d93593))
* **guild:** trial DPS split states how much of the party it covers ([6dad02b](https://github.com/Millennium44/Toolasha/commit/6dad02b8c968c0a99a6b680a9c75c8f14d9073dd))
* honest classification when the sync manifest is not ours ([88d3b46](https://github.com/Millennium44/Toolasha/commit/88d3b4659c8c705f0eb5cf3b37841cda2f2db06f))
* hug the combat forecast box against the enemies inside the monsters half ([022c94c](https://github.com/Millennium44/Toolasha/commit/022c94cd1617f66ceb1dd143694749851526d62f))
* **inventory:** stop the Inventory Badge Manager health-check false alarm ([2926d64](https://github.com/Millennium44/Toolasha/commit/2926d64b1cdac32683d219220cd68c21f5fb5446))
* Iron Cow re-forces after bulk writes; buff announcers clickable ([aa0a64d](https://github.com/Millennium44/Toolasha/commit/aa0a64da8e654357e60d8de69d1363ade2bc8a83))
* Lab Sim skilling crates default to equipped, add per-row calc breakdown ([5c0dad7](https://github.com/Millennium44/Toolasha/commit/5c0dad72f545e14621b219c7421ccf8ab73e41de))
* lab sim structural fixes from calibration review, and measured totals on trial rows ([72c43d6](https://github.com/Millennium44/Toolasha/commit/72c43d64024cba1f3a2e22e642a00e45c4efd9e7))
* **lab:** next-run restock phrasing, tier-aware hints, tooltip watchdog ([7a3d591](https://github.com/Millennium44/Toolasha/commit/7a3d59102d11158933d74403248d669628042371))
* **lab:** read run supply stock mid-run; game icons in the readout ([682e3d7](https://github.com/Millennium44/Toolasha/commit/682e3d7c29b7471471e5dd6523719019e5a8bcf7))
* labyrinth auto-calc button writes the checkbox setting correctly ([ae4efac](https://github.com/Millennium44/Toolasha/commit/ae4efac259d5f174d2ce612a73f29637e6f0d0a7))
* labyrinth mobile control bar and tile badge polish ([c5dee54](https://github.com/Millennium44/Toolasha/commit/c5dee54213675dfb101fb95af7c9e10f48b5d003))
* labyrinth monster rescale wiped resistance/armour buffs ([df52226](https://github.com/Millennium44/Toolasha/commit/df522260ebfc52e5beb95deaa1eebdc3276a3562))
* labyrinth path treats only entrance-connected clears as free starts ([d2b64f8](https://github.com/Millennium44/Toolasha/commit/d2b64f8859892e933577286df928a0a01a712146))
* **labyrinth:** diagnose over-modelled monster damage, not just under ([e6e7373](https://github.com/Millennium44/Toolasha/commit/e6e7373b944a5c6cb668248b4421d0222bf60e97))
* **labyrinth:** measure observed damage gross, not net of regen ([40bcde0](https://github.com/Millennium44/Toolasha/commit/40bcde094b0763821f073e0582fe5e4bb0d3f10f))
* **labyrinth:** stop counting un-fought rooms as clears; add uncapped sim option ([a58b82e](https://github.com/Millennium44/Toolasha/commit/a58b82ef4643299848a5cd3c2c4bad9e1b0e9679))
* **labyrinth:** stop self-healing monsters splitting one fight into many ([1dd1810](https://github.com/Millennium44/Toolasha/commit/1dd1810b4956d0b5b41b00bc2523ad3e8d49c086))
* legacy_ironcow characters never adopt legacy global data ([998d12b](https://github.com/Millennium44/Toolasha/commit/998d12bf9ce496c598e895f08e779f740f399a41))
* listener snapshots, shrine planner overflow, profit view read ([212625d](https://github.com/Millennium44/Toolasha/commit/212625d43ce4bc32d69b9cf25efca37e488b9081))
* live community buffs in lab readouts, house scopes, level source ([b78bd51](https://github.com/Millennium44/Toolasha/commit/b78bd5195babd7b113c9315991f57541da7bf03e))
* **loadout:** read the shared loadout store via the bridge in net worth, profit, and bulk-sell ([9f1c1e3](https://github.com/Millennium44/Toolasha/commit/9f1c1e3420b3c89a5c0f3e74e8b9a180f2ab9086))
* **loot-log:** price enhancing materials like the tracker does ([ba39e17](https://github.com/Millennium44/Toolasha/commit/ba39e17dfaeed8d54f1357630c5a5e69e9b4ad4c))
* market and inventory state scoped per character ([9f94fad](https://github.com/Millennium44/Toolasha/commit/9f94fade26bdf592a1ee00139dd14941e5cb1f68))
* **market:** auto-click-max was maxing the price, not the quantity ([fede808](https://github.com/Millennium44/Toolasha/commit/fede80881175127788937dc1d8eceba7c032c2b5))
* **market:** harden marketplace parsing and selectors for the market rework ([4d34a96](https://github.com/Millennium44/Toolasha/commit/4d34a96c9af593fbe9ccfc043d26738f343bef79))
* **market:** raise marketplace tax 2% → 5% (8/13/2026 game update) ([5adbef1](https://github.com/Millennium44/Toolasha/commit/5adbef1e0c03d8ff73b26b86454d10dca899533e))
* **market:** restore marketplace autofill after typable-input update ([e5992e2](https://github.com/Millennium44/Toolasha/commit/e5992e2523d5ea23913d0702ea5d3bad4d9c0401))
* **market:** show a fresh undercut in My Listings without opening the item ([2c8f100](https://github.com/Millennium44/Toolasha/commit/2c8f100bcee2ce5d49719679008608f24d0faaf2))
* **market:** show a fresh undercut in My Listings without opening the item ([8cba792](https://github.com/Millennium44/Toolasha/commit/8cba792d75490206e2b57c9adf7b9a1cbc2c54aa))
* mid-trial-upgrade cards use the exact ladder base for tokens ([92273ca](https://github.com/Millennium44/Toolasha/commit/92273caa82458e3e1ca92dc564f80a339c371dc0))
* nine cross-cutting debts from agent reports ([b1bdb02](https://github.com/Millennium44/Toolasha/commit/b1bdb0288df6b8a133366c93a85cceff1a9972be))
* notice boards purge from records, ladders locked with mid-trial upgrades ([dcb6942](https://github.com/Millennium44/Toolasha/commit/dcb694248553124ff80604414079a9b5e8653c25))
* **notifications:** stop undercut alerts forcing market fetches; surface rate-limits ([7e4b3c7](https://github.com/Millennium44/Toolasha/commit/7e4b3c7b0fcfda9c9948bc39c2d97b778dee982e))
* overlay reachable and readable on mobile ([97cd952](https://github.com/Millennium44/Toolasha/commit/97cd9520afd73ac6a3fb3e2348e053db882c084c))
* overlay settings popover no longer traps or goes stale ([f21ed88](https://github.com/Millennium44/Toolasha/commit/f21ed88ffb64313fb7fb63935c60ff64022e6ef7))
* pace arrow matches its count, completed overrides phase, split is an estimate ([faf2823](https://github.com/Millennium44/Toolasha/commit/faf2823eaa94b0554bacc12ed74387f0b348b6d0))
* panel open-state, overlay, and task prefs scoped per character ([31f83cf](https://github.com/Millennium44/Toolasha/commit/31f83cf4d80e4dfbe0bd950c675dbea3da6d8136))
* Path re-plans against the board as it stands, not the press-time snapshot ([47fae98](https://github.com/Millennium44/Toolasha/commit/47fae984aecd4ecf3f839e9494cd5e5f1b4de617))
* place a multi-enemy fight box below the grid like a single boss, no scroll ([4a29a42](https://github.com/Millennium44/Toolasha/commit/4a29a4274dd4af3def694adfa7460b1c1acc28ee))
* port upstream null-price guards and Custom Tabs button self-heal ([9fccc3a](https://github.com/Millennium44/Toolasha/commit/9fccc3aaec71d94f222a1896abde1c1de63662a5))
* portrait dps meters keep one height so party frames stop shifting ([1e7c7a8](https://github.com/Millennium44/Toolasha/commit/1e7c7a8a722f7be1a93641a3ab14aca13d9a5587))
* price ability level-ups from live experience, not the level floor ([2127339](https://github.com/Millennium44/Toolasha/commit/212733913295692324989a7a16546e4063cdde93))
* re-home any trial block stuck in a squashing row, not just the forecast ([c3399cc](https://github.com/Millennium44/Toolasha/commit/c3399ccf77d2798ad9027fa19858afe07847d915))
* read the reroll chooser structurally; MooPass-aware labels ([7442767](https://github.com/Millennium44/Toolasha/commit/74427675abb491c1173098dda7127b5ca48cbd4d))
* remove WebSocket prototype message wrapping ([c41c9b4](https://github.com/Millennium44/Toolasha/commit/c41c9b4d4d1bf1e4ca4aa83adad460471df15a89))
* roster rows come from the current member list, not the XP history ([d9ee23c](https://github.com/Millennium44/Toolasha/commit/d9ee23c4447fbdaecacd28341dc7ec13fd6a120e))
* seed wave baselines — first swings were invisible to the replay ([330c20b](https://github.com/Millennium44/Toolasha/commit/330c20bba79f031a5cd3ba872a114b7133e78072))
* self-healing trial records, lifecycle-aware panel, trial notifications ([4fad88c](https://github.com/Millennium44/Toolasha/commit/4fad88ce2e73bbd3d97e937dbc9a45588cb30a2e))
* **settings:** make every audited setting do what it says ([08f0a88](https://github.com/Millennium44/Toolasha/commit/08f0a88de3c89fc22108bdbabb36fc2ec4a8fff1))
* **settings:** open the real treasure ledger via the bundle bridge in packaged builds ([4717b9e](https://github.com/Millennium44/Toolasha/commit/4717b9ec0290bdeb39232b75c38277237b0243a8))
* **settings:** remove stale experimental warning from task reroll tracker ([173f642](https://github.com/Millennium44/Toolasha/commit/173f642504662c6effe43f8b425bb9d9d3636011))
* **settings:** remove the stale experimental warning from the task reroll tracker ([d3ccd8b](https://github.com/Millennium44/Toolasha/commit/d3ccd8bf4078b740966db756d15181e8895d23e9))
* sim skilling clear rate reads success and gathering gear stats ([531f25e](https://github.com/Millennium44/Toolasha/commit/531f25eafe7d15bd796ebae6d9f9d6cd6a1ca41b))
* **sim:** apply ability updates live; capture and persist shrine levels ([49de248](https://github.com/Millennium44/Toolasha/commit/49de24809cb29cd201f43588a448f90586ae38c7))
* **sim:** scope all-zones snapshot, upgrade selections, and lab keys per character ([5a86291](https://github.com/Millennium44/Toolasha/commit/5a86291dd8fef347d15ce8200eec6afd63a77df5))
* **sim:** scope house buffs to combat, per-player guild buffs, live Experience token ([7688408](https://github.com/Millennium44/Toolasha/commit/768840844bf56e1deb63939b26b635719d9175a1))
* skilling cost details, swap exclusivity, unpriced-never-free ([4d42586](https://github.com/Millennium44/Toolasha/commit/4d42586e4116e551a9d07eb000435738601ec956))
* skilling trial forecast block no longer squashes the unit icon ([36988cb](https://github.com/Millennium44/Toolasha/commit/36988cb552123290a4d5aff146b44d0ebbf85ec7))
* span trial forecast boxes across the outer tab grid, not the one-cell tile ([f05c9dd](https://github.com/Millennium44/Toolasha/commit/f05c9dd8a3c3101d7423150a4cb0c16061c1e842))
* spectated pool attaches to the watched encounter, wipes are outcomes ([bbeeb64](https://github.com/Millennium44/Toolasha/commit/bbeeb6458d3d5d96cd12eddebbeb650804b6696c))
* stamp sim-export bridge payloads with the writing character ([60429f5](https://github.com/Millennium44/Toolasha/commit/60429f5cdc67691ff48bc5f72fdce4ca7ddad4ae))
* start tooltip feature when any tooltip section is enabled ([f50e2ba](https://github.com/Millennium44/Toolasha/commit/f50e2ba209aeca1ce4f8a4e9cb6d11767c3a4c9f))
* stop labyrinth auto-calc looping the bar on a static floor; move toggle inline ([ecf435b](https://github.com/Millennium44/Toolasha/commit/ecf435b1abf3a7659ac34826cfc802d2bd5af728))
* stop the live clear-chance readout reflowing the fight header ([448c3b2](https://github.com/Millennium44/Toolasha/commit/448c3b219618ae263f92026ed45f2dfa13a01cc9))
* sustainable goal-planner rates, loadout staleness, buy handoffs ([4f3519f](https://github.com/Millennium44/Toolasha/commit/4f3519f8b64a2cbdf0df6e45bd662f85701441f1))
* sweep stale action-bar profit nodes before reinjecting ([1d653da](https://github.com/Millennium44/Toolasha/commit/1d653da7c43ef8499e851a2af63cfd32ed95489a))
* task cards settle after rerolls, free MooPass unstuck ([c0a2067](https://github.com/Millennium44/Toolasha/commit/c0a20679d797653d555c58fba0955b36f0be5c6a))
* **tasks:** bulk reroll presses the menu instead of just opening it ([063a899](https://github.com/Millennium44/Toolasha/commit/063a899999b7fcf21d448bb2a6e1a4e00e41acdf))
* **tasks:** draw the protected task border synchronously when a card appears ([8c98d60](https://github.com/Millennium44/Toolasha/commit/8c98d60851add6c512a88bb5b2b0564b5a4b48ef))
* **tasks:** open the reroll chooser with a dispatched event so it works without a manual press ([c357813](https://github.com/Millennium44/Toolasha/commit/c3578136131d2f8d3d6fc7f66f508f9c32590e27))
* **tasks:** read the reroll chooser off the whole card so paid options are found ([da6455d](https://github.com/Millennium44/Toolasha/commit/da6455d04faf8cffa4dc86f888428ecbe8c1bc2a))
* **tasks:** settle a just-opened reroll chooser, and silence the worker math.js source-map error ([0a2e159](https://github.com/Millennium44/Toolasha/commit/0a2e159ddc63c8f11822d9b7808c5802c70cc7ab))
* **tasks:** stop interfering with the game's reroll and discard flows ([6ccc66a](https://github.com/Millennium44/Toolasha/commit/6ccc66a2e5d1784994cf0b4c8a176de145876db0))
* **tasks:** update the protected border on a mid-flow card, and drop the diagnostics ([3ee744b](https://github.com/Millennium44/Toolasha/commit/3ee744b7f9ec4d190345c93295b47a40544d32fd))
* **tooltips:** detect the ability tooltip by name, not a sprite ([c86f73f](https://github.com/Millennium44/Toolasha/commit/c86f73f138760bec3d6d2bf45a185975a0e760a2))
* trial blocks stay off non-trial tabs, recorder needs a live phase, cards render per phase ([aaf2d35](https://github.com/Millennium44/Toolasha/commit/aaf2d3554b1474a6fc1df5ffa56c035260cf344e))
* trial data re-keys on character switch, stable side-block layout, scroll preserved ([38ff11e](https://github.com/Millennium44/Toolasha/commit/38ff11e062a1de769c2258d7f80d1d3f8dc4e66f))
* trial export-proven defects — damage gate, sampler, tiers, guild name, stat kinds, overlap ([a11d255](https://github.com/Millennium44/Toolasha/commit/a11d25597a4ebf02b5f57e32bd334b70c00ccbff))
* trials read both real tabs, structural clock, lazy guild key ([63b956f](https://github.com/Millennium44/Toolasha/commit/63b956f7f3efb12b3af8841b7c4f3e41bc33b09b))
* trials round three — full payout digits, tab-scoped roster, measured placement, participation captions ([baba330](https://github.com/Millennium44/Toolasha/commit/baba33043a1f22121d2ceb023129c784a6a3b9d5))
* **trials:** label damage-taken pre/post-mitigation and flag over-attributed splits ([22d95d7](https://github.com/Millennium44/Toolasha/commit/22d95d7fe0a02555eb2a07fb96d00353a94ee2e7))
* **trials:** read partial-tier card figures as valid, not a ladder disagreement (test server) ([82e1da6](https://github.com/Millennium44/Toolasha/commit/82e1da6c9b5e75fb9f1f7f59b9ffcc2ece5673bf))
* **trials:** resolve composite-trial encounters so Trial Swarm anchors its tier ([8b62df9](https://github.com/Millennium44/Toolasha/commit/8b62df94be238dd169a8e85cd63830cc716fee4c))
* **trials:** stop injected blocks squashing the skilling In Progress card ([f7f9db2](https://github.com/Millennium44/Toolasha/commit/f7f9db2c77e36c02c95fbf7063d93fbbf804a1fa))
* trim guild trial payout notes and forecast text ([b1c37fa](https://github.com/Millennium44/Toolasha/commit/b1c37fa368f5ee07058e7a60a00452995e2b75d7))
* **ui:** default sims to Score sort, fix minimize placement, clickable quiet members ([be227cc](https://github.com/Millennium44/Toolasha/commit/be227cc11cb0a7307faab3f8223df9ec90a06d74))
* unpaint the sticky action-button strip; untangle pin classes ([5f119ae](https://github.com/Millennium44/Toolasha/commit/5f119ae5519a6c458ee45844ee85699c6aefe015))
...
* zone-index badge only touches the DOM on change ([e38a681](https://github.com/Millennium44/Toolasha/commit/e38a6810bd068835e46f33325faad9e0adee3c59))


### Code Refactoring

* **lab:** split clear-rate module; supply-aware planner; stable live readout ([044b14c](https://github.com/Millennium44/Toolasha/commit/044b14cc4833fe337665a6ff36822be12949cdcb))
* **trials:** make the stats-modal scraper header-driven (combat + skilling) ([21e0b32](https://github.com/Millennium44/Toolasha/commit/21e0b3297365d6a8b1876f824ee03f5ad5d31d06))


### Performance Improvements

* anchor party Profile button on role=tablist, not a document sweep ([6963066](https://github.com/Millennium44/Toolasha/commit/6963066760bc53bad6bb5f45dc20eb1e5848e0a0))
* bound the trials DOM-observer debounce so the overlay paints fast ([58c096c](https://github.com/Millennium44/Toolasha/commit/58c096cba5598df26d58ff65d71f72b7ee466d81))
* **inventory:** time-slice badge pricing so an enhanced inventory doesn't freeze startup ([b52ac67](https://github.com/Millennium44/Toolasha/commit/b52ac677dede60d2347c59e1b8695d010e29b725))
* lighten the trials render pass — scan, text walk, and squash probe ([748db13](https://github.com/Millennium44/Toolasha/commit/748db13a2a7a8ce1c42d8798768699d2e04cbee2))
* split append-heavy history into per-period records ([0698cb6](https://github.com/Millennium44/Toolasha/commit/0698cb6c7ec054cfeef203536ecfe903c0b1e0e5))
* **startup:** split feature init timing into own-work vs await-drain ([35df5a2](https://github.com/Millennium44/Toolasha/commit/35df5a27f961e6afd386fe543e808a512e87c8a8))


### Documentation

* **changelog:** apply prettier markdown formatting ([f37ee04](https://github.com/Millennium44/Toolasha/commit/f37ee04a64958685b4630b057ec4dda1abb31139))
* **changelog:** condense fork changelog entries and require short ones ([17bf933](https://github.com/Millennium44/Toolasha/commit/17bf933b085018a9526b4e980b6faa4365761dd1))
* **changelog:** condense the new-session fork entries ([596f27d](https://github.com/Millennium44/Toolasha/commit/596f27ddb37a8039e39bf0dceafe5e001ec585a1))
* **changelog:** condense the new-session fork entries to one or two lines each ([337e5af](https://github.com/Millennium44/Toolasha/commit/337e5afe6a6d70d58588061d5c6104182c317369))
* **changelog:** correct the loadout fix description ([016dd74](https://github.com/Millennium44/Toolasha/commit/016dd744248a2d537d0358abbee671df61364453))
* greasyfork listing body with fork summary and visible credits ([aa652b2](https://github.com/Millennium44/Toolasha/commit/aa652b2d90221f4fe123a0891a1ea8db0749e12c))
* **greasyfork:** drop Iron Cow mode from the fork's additions list ([5dd472b](https://github.com/Millennium44/Toolasha/commit/5dd472b0a5c7e8de42aca5056492d971d32563f0))
* **greasyfork:** frame the fork as Toolasha + Combat Suite, add Ctrl+K and tweak count ([027e8bd](https://github.com/Millennium44/Toolasha/commit/027e8bd3fa2aa709193fbfae3b3853c08e6ecb41))
* **greasyfork:** lead with how the pieces integrate and how far market prices reach ([169bb0d](https://github.com/Millennium44/Toolasha/commit/169bb0dc2ed2fe967b5183afb4a8812114ce6de6))
* **greasyfork:** reframe sim-upgrade and labyrinth bullets to fork-distinct angles ([6084a55](https://github.com/Millennium44/Toolasha/commit/6084a55ddd0dc7ac409f0015af791678f8fe6595))
* **greasyfork:** reword per-character bullet, soften mobile claim ([6ea8b2b](https://github.com/Millennium44/Toolasha/commit/6ea8b2be6a44646d329d54b5219407c864d02669))
* **greasyfork:** soften the mobile bullet to "Mobile-friendly touches" ([cd3ad29](https://github.com/Millennium44/Toolasha/commit/cd3ad29dab7d8ccd2449663c435c46d90778b21b))
* **greasyfork:** trim inherited clauses from labyrinth, guild, and task bullets ([7b9e406](https://github.com/Millennium44/Toolasha/commit/7b9e406548bbcb45cf1a0e19b0b46281bba85f0e))
* **greasyfork:** trim Iron Bell from the listing, refresh guild tools and test count ([7ede069](https://github.com/Millennium44/Toolasha/commit/7ede0699c63743020c41b4ce88cf7c38e998079a))
* **greasyfork:** trim the upgrade-advisor bullet to its fork-new parts ([b1ff904](https://github.com/Millennium44/Toolasha/commit/b1ff904a44dc970e0cbbc52b99915383481839cf))
* note tradable-range band is a bounded ~10% approximation ([2f0d930](https://github.com/Millennium44/Toolasha/commit/2f0d93091a33bb5fce9fe95c12e55d4318534b42))
* rollup comments name the real bundle ceiling ([7e9e1bc](https://github.com/Millennium44/Toolasha/commit/7e9e1bc62a0e728120a4d1447d27739292bb466d))
* scrub companion-script name from the changelog; add the no-naming rule ([10e4ae5](https://github.com/Millennium44/Toolasha/commit/10e4ae585a1d94be7f3425162321f4dde77cc375))
* standing rule to work directly on main ([6efbb7c](https://github.com/Millennium44/Toolasha/commit/6efbb7cdb18bf22a20359892dd8f157d354cecb9))
* update stale "2%" market-tax notes to 5% ([c5e5a95](https://github.com/Millennium44/Toolasha/commit/c5e5a95dccbd1b8d39530bb4fddd40a2c7cc45fc))


### Styles

* format files that drifted past lint-staged ([0a23761](https://github.com/Millennium44/Toolasha/commit/0a237614276b938e3b8b63e40d78cdff41828935))
* wrap the skill-milestone test import to satisfy prettier ([e800d2d](https://github.com/Millennium44/Toolasha/commit/e800d2dd9f1190f3d45c54b211821703a7328620))


### Tests

* dungeon tracker, chat annotations, collections, and exports ([4717c30](https://github.com/Millennium44/Toolasha/commit/4717c30fd9a1fb3eb0ee9e8fed57ec06e29d906d))
...
* storage estimate suite provides its own navigator on Node 20 ([ed9fab8](https://github.com/Millennium44/Toolasha/commit/ed9fab8d82dadb63a21db4c4973f695447e31c9c))
* variance fixtures, alchemy wrappers, and core util coverage ([a6762f2](https://github.com/Millennium44/Toolasha/commit/a6762f214dc921d108fc0cff8504485cfe234979))


### Build System

* allowlist stateless loadout-scraper across the market bundle ([c183f49](https://github.com/Millennium44/Toolasha/commit/c183f490e6758f269c9cb8879adf3d5354657c9f))
* dev). ([443ac00](https://github.com/Millennium44/Toolasha/commit/443ac00d3b318a60924e809c9883c57a4b0ef036))
* **dev:** stamp the dev userscript version so a reinstall always takes ([c8b4ae1](https://github.com/Millennium44/Toolasha/commit/c8b4ae16ccc9336eeab041f1104c07bda66ee440))
* move guild features from the ui library to the combat library ([10b2050](https://github.com/Millennium44/Toolasha/commit/10b20500892fb363524685f1273b7a2e3521364a))
* **userscript:** expand and tidy the author credit ([79811e2](https://github.com/Millennium44/Toolasha/commit/79811e276f0674b08ac171902cc66a71826c0498))
* **userscript:** expand and tidy the author credit ([014b04a](https://github.com/Millennium44/Toolasha/commit/014b04a6b9688b65c5cb323a0177d8adf381174a))
* **userscript:** lead the author credit with Millennium44 ([0b4fc15](https://github.com/Millennium44/Toolasha/commit/0b4fc150ba551cc6a268cee5f0a35efa9698bfd3))
* **userscript:** lead the author credit with Millennium44 ([3946505](https://github.com/Millennium44/Toolasha/commit/3946505f6ed0b33433988ee9e575c49056e622b8))
* **userscript:** lead the production author credit with Millennium44 ([7facf8a](https://github.com/Millennium44/Toolasha/commit/7facf8ae7d89ef1f7dcfc3aac03576ed4028cad2))
* **userscript:** lead the production author credit with Millennium44 ([a865843](https://github.com/Millennium44/Toolasha/commit/a8658431b4a11f5588a35c24317cee4fce59ffe8))


### Continuous Integration

* allow manual dispatch of the release workflow ([c33ba70](https://github.com/Millennium44/Toolasha/commit/c33ba70ba188f3d574d425bb35b389a2be892f5d))
* harden release publish against oversized notes; add manual re-publish ([8db3ff6](https://github.com/Millennium44/Toolasha/commit/8db3ff69c93cd4de55c304089c7e5aeff0d9a69e))


### Miscellaneous Chores

* format the release-please changelog section ([60da8c2](https://github.com/Millennium44/Toolasha/commit/60da8c289df04c0451cea1487fd4cef8909192ec))
* **main:** release 2.100.0 ([5b986ed](https://github.com/Millennium44/Toolasha/commit/5b986eda85320dd3b19637ad2cbd50472400e5a6))
* **main:** release 2.100.0 ([055e1fc](https://github.com/Millennium44/Toolasha/commit/055e1fcfbcfcdb54cfa9684732d1f3535aa2c312))
* **main:** release 2.101.0 ([8d17511](https://github.com/Millennium44/Toolasha/commit/8d175117dbdf2b9038f5374c77352c7cedf4e621))
* **main:** release 2.102.0 ([2b2385a](https://github.com/Millennium44/Toolasha/commit/2b2385a80849f8920a0948cf6027d64eb20d0f96))
* **main:** release 2.89.0 ([8665904](https://github.com/Millennium44/Toolasha/commit/8665904f18f2f6f9c478d5218e1f6cd3f721cf76))
* **main:** release 2.89.0 ([bfee25a](https://github.com/Millennium44/Toolasha/commit/bfee25a532e65f92d1e7751e0e1abe4ac1fb87fe))
* **main:** release 2.90.0 ([ca80f2b](https://github.com/Millennium44/Toolasha/commit/ca80f2b089ec9ddbdae8c74c269792d8df6f3557))
* **main:** release 2.90.0 ([9c8e0b3](https://github.com/Millennium44/Toolasha/commit/9c8e0b3fab25576237eab7cd9fffba370b7e36db))
* **main:** release 2.91.0 ([28030ec](https://github.com/Millennium44/Toolasha/commit/28030ec2fee28fe710ec1a348a8e19b71dc5f339))
* **main:** release 2.91.0 ([6f06f58](https://github.com/Millennium44/Toolasha/commit/6f06f58d835f57f76ef8157e62573467910c3571))
* **main:** release 2.92.0 ([337f020](https://github.com/Millennium44/Toolasha/commit/337f020fd755d3ce31bbb50ae4e02817b4cc3367))
* **main:** release 2.92.0 ([9f74030](https://github.com/Millennium44/Toolasha/commit/9f740304ee695f84ae33a76d876b555c4c4e652a))
* **main:** release 2.92.1 ([f7896c5](https://github.com/Millennium44/Toolasha/commit/f7896c5e2f9d2d4e09f54694f9ced245178453b6))
* **main:** release 2.92.1 ([704f691](https://github.com/Millennium44/Toolasha/commit/704f691e3c1f6b2ac11bb1a8d78a9fa86b27ccb2))
* **main:** release 2.93.0 ([#14](https://github.com/Millennium44/Toolasha/issues/14)) ([69ea77d](https://github.com/Millennium44/Toolasha/commit/69ea77d1bd72455db8660a5ee3ed118c6fc24a72))
* **main:** release 2.94.0 ([#15](https://github.com/Millennium44/Toolasha/issues/15)) ([6f3c981](https://github.com/Millennium44/Toolasha/commit/6f3c9810edd9c9b7547200ea43992fc5e06c6edd))
* **main:** release 2.95.0 ([2ad1b4d](https://github.com/Millennium44/Toolasha/commit/2ad1b4dabae510d1f790c3b784d08c86585cb4e7))
* **main:** release 2.95.0 ([beef488](https://github.com/Millennium44/Toolasha/commit/beef488e5cf0a6204773c1ad7c7318424c34bc76))
* **main:** release 2.95.1 ([50c6dd1](https://github.com/Millennium44/Toolasha/commit/50c6dd1aafded0a2c76849598b117d291f271d46))
* **main:** release 2.95.1 ([29cf95f](https://github.com/Millennium44/Toolasha/commit/29cf95fcd970559451e79566cbe58f7e469b0ba8))
* **main:** release 2.96.0 ([33da7cf](https://github.com/Millennium44/Toolasha/commit/33da7cf929e2a3d95a8ce4b24dfd3c5cc8af3e84))
* **main:** release 2.96.0 ([09d8dbd](https://github.com/Millennium44/Toolasha/commit/09d8dbd43afe3bf33533a8fbd43ee3c8b37f60dd))
* **main:** release 2.96.1 ([56bdf6f](https://github.com/Millennium44/Toolasha/commit/56bdf6ff9e4ad5e392fb3b405a38fe68afac569d))
* **main:** release 2.96.1 ([cbaddad](https://github.com/Millennium44/Toolasha/commit/cbaddadcbc40542c1206ebc03fc12bbb4d997dbd))
* **main:** release 2.96.2 ([db050fc](https://github.com/Millennium44/Toolasha/commit/db050fc2f65abcb8d3ff135d6391d8314ef7490a))
* **main:** release 2.96.2 ([fed7cfa](https://github.com/Millennium44/Toolasha/commit/fed7cfa858658a7d89cb302b7337706eefd386cd))
* **main:** release 2.96.3 ([f7ba450](https://github.com/Millennium44/Toolasha/commit/f7ba450983e48107c4b5161e6733038ba49b28e5))
* **main:** release 2.96.3 ([1758fd9](https://github.com/Millennium44/Toolasha/commit/1758fd9db7b2f281b602b27239260047b46ec55c))
* **main:** release 2.96.4 ([b90464d](https://github.com/Millennium44/Toolasha/commit/b90464d3e8dcca00aa8220aa6d9ad9467866a205))
* **main:** release 2.96.4 ([af94244](https://github.com/Millennium44/Toolasha/commit/af942448ce841c3f2499aeed94f5079c66177541))
* **main:** release 2.96.5 ([ec34938](https://github.com/Millennium44/Toolasha/commit/ec3493861ae83d0f6de961ffabaa7a1497c6aae3))
* **main:** release 2.96.5 ([0b8278d](https://github.com/Millennium44/Toolasha/commit/0b8278d6682971bafa49729e70e692d45291addb))
* **main:** release 2.97.0 ([c6a7cac](https://github.com/Millennium44/Toolasha/commit/c6a7cac72b7ef8f12ad454a20ec7c7e8df6f47f5))
* **main:** release 2.97.0 ([ccd3e41](https://github.com/Millennium44/Toolasha/commit/ccd3e4152cee1744df1fccf439276c17dd913b11))
* **main:** release 2.98.0 ([b110c86](https://github.com/Millennium44/Toolasha/commit/b110c86b75e32d8563c66fa859342cd30c4f6cac))
* **main:** release 2.98.0 ([a2dcb3f](https://github.com/Millennium44/Toolasha/commit/a2dcb3fe31d252296e22b4318f51442755955f04))
* **main:** release 2.99.0 ([4a40012](https://github.com/Millennium44/Toolasha/commit/4a40012fac391ea932e08b617cd72e6c9a6a3418))
* **main:** release 2.99.0 ([2d9fc28](https://github.com/Millennium44/Toolasha/commit/2d9fc2890958ade878e148b90943acb70ddad496))
* **main:** release 3.0.0 ([4850861](https://github.com/Millennium44/Toolasha/commit/48508611ba17efc04c5a88f4fda19702f5dc997f))
* **main:** release 3.0.0 ([a6e2d20](https://github.com/Millennium44/Toolasha/commit/a6e2d205f140caaeb8fa1573af59f18d69ad5bc9))
* **main:** release 3.0.1 ([85f1085](https://github.com/Millennium44/Toolasha/commit/85f1085b7d5a3f36b65ddf775fd5ab8e4378d822))
* **main:** release 3.0.1 ([4386999](https://github.com/Millennium44/Toolasha/commit/4386999797d041374382bdc6423a089f0f68d1c0))
* **main:** release 3.1.0 ([#43](https://github.com/Millennium44/Toolasha/issues/43)) ([c09cca5](https://github.com/Millennium44/Toolasha/commit/c09cca597e856324aaf6e6913343f9e6c059e726))
* **main:** release 3.1.1 ([#44](https://github.com/Millennium44/Toolasha/issues/44)) ([773fbbf](https://github.com/Millennium44/Toolasha/commit/773fbbf288bbeea55e2d8e6719bb8ecef9e7f447))
* **main:** release 3.10.0 ([#58](https://github.com/Millennium44/Toolasha/issues/58)) ([bde524e](https://github.com/Millennium44/Toolasha/commit/bde524ea3d2e1f3544fa67ba9cd8a909c629666d))
* **main:** release 3.11.0 ([#59](https://github.com/Millennium44/Toolasha/issues/59)) ([4d5255a](https://github.com/Millennium44/Toolasha/commit/4d5255a52f0313c1bc2a3855825cdbc7196f2e97))
* **main:** release 3.12.0 ([#60](https://github.com/Millennium44/Toolasha/issues/60)) ([c544d1c](https://github.com/Millennium44/Toolasha/commit/c544d1c787475bb8ba5785aac721916aad02adf6))
* **main:** release 3.12.1 ([#61](https://github.com/Millennium44/Toolasha/issues/61)) ([849989e](https://github.com/Millennium44/Toolasha/commit/849989e60feee94604f0c138f20949be23a3c5f9))
* **main:** release 3.2.0 ([#45](https://github.com/Millennium44/Toolasha/issues/45)) ([21ea4f5](https://github.com/Millennium44/Toolasha/commit/21ea4f5607f708a60d0cead76b1fafb640bff62a))
* **main:** release 3.2.1 ([#46](https://github.com/Millennium44/Toolasha/issues/46)) ([96423c2](https://github.com/Millennium44/Toolasha/commit/96423c245d778e7cc747d6385674d6fd542ffd57))
* **main:** release 3.3.0 ([#47](https://github.com/Millennium44/Toolasha/issues/47)) ([d46a7b3](https://github.com/Millennium44/Toolasha/commit/d46a7b3410a6d4dbfef8ad40eb08b91a06043473))
* **main:** release 3.4.0 ([#48](https://github.com/Millennium44/Toolasha/issues/48)) ([78ea16b](https://github.com/Millennium44/Toolasha/commit/78ea16be08a03b91e5942432c100419d1db387eb))
* **main:** release 3.5.0 ([#49](https://github.com/Millennium44/Toolasha/issues/49)) ([7905bc6](https://github.com/Millennium44/Toolasha/commit/7905bc661556b69c3fe1f9c992307113cb08db8d))
* **main:** release 3.5.1 ([#50](https://github.com/Millennium44/Toolasha/issues/50)) ([a5be3f2](https://github.com/Millennium44/Toolasha/commit/a5be3f2f570b378c626c164696e5a44b1bc4a444))
* **main:** release 3.5.2 ([#51](https://github.com/Millennium44/Toolasha/issues/51)) ([2ab913e](https://github.com/Millennium44/Toolasha/commit/2ab913e61fb99e61447cc52dc7655349e65436e0))
* **main:** release 3.6.0 ([#52](https://github.com/Millennium44/Toolasha/issues/52)) ([9e31945](https://github.com/Millennium44/Toolasha/commit/9e31945fa83512e4c1103f648dd8808af226d09a))
* **main:** release 3.6.1 ([#53](https://github.com/Millennium44/Toolasha/issues/53)) ([b6543b2](https://github.com/Millennium44/Toolasha/commit/b6543b2c3758c57daba605e02a0e64be57283620))
* **main:** release 3.7.0 ([#54](https://github.com/Millennium44/Toolasha/issues/54)) ([256ec57](https://github.com/Millennium44/Toolasha/commit/256ec57782d31b7b285ea9003042b23e743d0452))
* **main:** release 3.8.0 ([7e0d50c](https://github.com/Millennium44/Toolasha/commit/7e0d50c2da3ac8dec3a10de0368738b30390d778))
* **main:** release 3.8.0 ([8e3d90e](https://github.com/Millennium44/Toolasha/commit/8e3d90ec038b3acb6c9dc613d78da53a410d0472))
* **main:** release 3.9.0 ([#56](https://github.com/Millennium44/Toolasha/issues/56)) ([516f474](https://github.com/Millennium44/Toolasha/commit/516f4747e154921151260d206d6020fe0d1ffffa))
* **main:** release 3.9.1 ([#57](https://github.com/Millennium44/Toolasha/issues/57)) ([383f193](https://github.com/Millennium44/Toolasha/commit/383f193fb439c78f7b12a2cc032a2716e824f2ae))
...
* raise bundle ceiling to 3.5MiB now the sharing check guards duplication ([bb1102c](https://github.com/Millennium44/Toolasha/commit/bb1102c5bf72df0b99e36523443b9e6f6273ce2a))
* raise the bundle ceiling to 3 MiB ([ab105a4](https://github.com/Millennium44/Toolasha/commit/ab105a48a1d7d0d25a0465726a1fc8b5f2260352))
* release Toolasha 3.0.0 ([b453ba1](https://github.com/Millennium44/Toolasha/commit/b453ba135749855991033794ef02f490aa585cca))
* **release:** write real release notes into the greasyfork-facing commit ([e33655b](https://github.com/Millennium44/Toolasha/commit/e33655bf97efdbce26c001948ffd3bbd13a9ebf2))
* restore original pin settings; document 3.8.0's later changes ([e3cbc17](https://github.com/Millennium44/Toolasha/commit/e3cbc1724beb3bce28f9d38e9c0e90fc6e7ebb14))
* stamp userscript headers at 2.90.0 ([08d85bb](https://github.com/Millennium44/Toolasha/commit/08d85bb86e5fcc661fff6d22a48ea052a99cece2))
* sync [@version](https://github.com/version) to 3.2.0 and stamp version at publish time ([d207c55](https://github.com/Millennium44/Toolasha/commit/d207c5508226f4b1df022dcba1020fe77040a866))
* sync version and format release notes ([24f9848](https://github.com/Millennium44/Toolasha/commit/24f98482a8fe9d1c35f48ad1810a127438c4a2a1))
* sync version and format release notes ([4db834c](https://github.com/Millennium44/Toolasha/commit/4db834cb140f4a556dfa68e44af05f6000b4018b))
* sync version and format release notes ([a39a988](https://github.com/Millennium44/Toolasha/commit/a39a9884056a6d764fd43b95936a08fd98cc16a9))
* sync version and format release notes ([b749037](https://github.com/Millennium44/Toolasha/commit/b749037641e804479b6ac33c29fb63245b322280))
* sync version and format release notes ([ffbf4d5](https://github.com/Millennium44/Toolasha/commit/ffbf4d53d3878282eff680016a05b17552c3040f))
* sync version and format release notes ([a7cdd66](https://github.com/Millennium44/Toolasha/commit/a7cdd669942c46fc964d0617cf00be5cbcc4c254))
* sync version and format release notes ([340746b](https://github.com/Millennium44/Toolasha/commit/340746b773b4c03a8db6043127d3540c2c08299a))
* sync version and format release notes ([17d58a5](https://github.com/Millennium44/Toolasha/commit/17d58a5657a621533e3fb5750f84b56116fe15f2))
* sync version and format release notes ([ddc20a8](https://github.com/Millennium44/Toolasha/commit/ddc20a80c2d462c508281f8c55d470512c0ee5fa))
* sync version and format release notes ([143b710](https://github.com/Millennium44/Toolasha/commit/143b710d2fbd6419155ed595e87ce9435d08e78f))
* sync version and format release notes ([b63da20](https://github.com/Millennium44/Toolasha/commit/b63da20aae9602cd3fb14fa18f18435d4cef48b2))
* sync version and format release notes ([e2ba0f0](https://github.com/Millennium44/Toolasha/commit/e2ba0f0048959e2f15484f958875eccd5aa22b3d))
* sync version and format release notes ([d41ebbb](https://github.com/Millennium44/Toolasha/commit/d41ebbb93d839efc42ec7302056fc339b8b5087c))
* sync version and format release notes ([0ed64a4](https://github.com/Millennium44/Toolasha/commit/0ed64a4cc0ca877aff8faa7d49fade03b359b11b))
* sync version and format release notes ([2faadbc](https://github.com/Millennium44/Toolasha/commit/2faadbcb378ba8711a283755ecd8471617af7db6))
* sync version and format release notes ([b369816](https://github.com/Millennium44/Toolasha/commit/b369816def45469b868e4a7c8385ee67f57cb349))
* sync version and format release notes ([bc63b03](https://github.com/Millennium44/Toolasha/commit/bc63b03a2accf45d52c21f4cd5e2952d725c6f65))
* sync version and format release notes ([c4f761c](https://github.com/Millennium44/Toolasha/commit/c4f761c99173d9ff8670352030542812b0ea7c0e))
* sync version and format release notes ([e56c734](https://github.com/Millennium44/Toolasha/commit/e56c734d36fd006c18c5007d7f5ad800a1015af1))
* **tasks:** temporary protection-repaint diagnostics ([7978f7b](https://github.com/Millennium44/Toolasha/commit/7978f7b099746acd2df2269399a2faaa22e205ab))


### Reverts

* restore the Sell Queue feature unchanged ([b9f616f](https://github.com/Millennium44/Toolasha/commit/b9f616f995b9e679fb0fd9e330cb8894f1228f27))
* **sim:** house action buffs apply to combat again — live game does this ([b556255](https://github.com/Millennium44/Toolasha/commit/b5562558338fd843f06fa24aece4b887628e0c7b))
